    ...
    return function e(t, n, r) {
            ...
            ! function(e) {
                ...
                n.encode = function(t) {
                    ...
                    var p = new ArrayBuffer(s),
                        u = new Uint8Array(p);
                    for (n = 0; n < c; n += 4) r = e.indexOf(t[n]), i = e.indexOf(t[n + 1]), o = e.indexOf(t[n + 2]), a = e.indexOf(t[n + 3]), u[d++] = r << 2 | i >> 4, u[d++] = (15 & i) << 4 | o >> 2, u[d++] = (3 & o) << 6 | 63 & a;
                    return p
                }
        ...
        12: [function(e, t, n) {
            (function(n) {
                function r(e, t) {
                    ...
                    if (t = t || {}, e && "object" == typeof e && (t = e, e = null), e && (e = p(e), t.host = e.host, t.secure = "https" == e.protocol || "wss" == e.protocol, t.port = e.port, e.query && (t.query = e.query)), this.secure = null != t.secure ? t.secure : n.location && "https:" == location.protocol, t.host) {
                        var i = t.host.split(":");
                ...
                t.exports = r, r.priorWebsocketSuccess = !1, a(r.prototype), r.protocol = d.protocol, r.Socket = r, r.Transport = e("./transport"), r.transports = e("./transports"), r.parser = e("engine.io-parser"), r.prototype.createTransport = function(e) {
                    ...
                    function t() {
                        ...
                        u || (s('probe transport "%s" opened', e), p.send([{
                            type: "ping",
                            data: "probe"
                            ...
                            if (!u)
                                if ("pong" == t.type && "probe" == t.data) {
                                    ...
                                    r.priorWebsocketSuccess = "websocket" == p.name, s('pausing current transport "%s"', l.transport.name), l.transport.pause(function() {
                                        u || "closed" != l.readyState && (s("changing transport and sending upgrade packet"), d(), l.setTransport(p), p.send([{
                                            type: "upgrade"
                    ...
                    function n() {
                        u || (u = !0, d(), p.close(), p = null)
                    }

                    function i(t) {
                        var r = new Error("probe error: " + t);
                        r.transport = p.name, n(), s('probe transport "%s" failed because of error: %s', e, t), l.emit("upgradeError", r)
                    }
                    ...
                    function c(e) {
                        p && e.name != p.name && (s('"%s" works - aborting "%s"', e.name, p.name), n())
                    }
                    ...
                    var p = this.createTransport(e, {
                        ...
                        u = !1,
                        l = this;
                    r.priorWebsocketSuccess = !1, p.once("open", t), p.once("error", i), p.once("close", o), this.once("close", a), this.once("upgrading", c), p.open()
                ...
                function r(e) {
                    ...
                    if (t.location) {
                        var d = "https:" == location.protocol,
                            p = location.port;
                        p || (p = d ? 443 : 80), r = e.hostname != location.hostname || p != e.port, s = e.secure != d
                    }
        ...
        16: [function(e, t, n) {
            (function(n) {
                ...
                t.exports = i, t.exports.Request = o, p(i, c), i.prototype.supportsBinary = !0, i.prototype.request = function(e) {
        ...
        22: [function(e, t, n) {
            ...
            function i(e) {
                return e >= p ? Math.round(e / p) + "d" : e >= d ? Math.round(e / d) + "h" : e >= c ? Math.round(e / c) + "m" : e >= s ? Math.round(e / s) + "s" : e + "ms"
            }

            function o(e) {
                return a(e, p, "day") || a(e, d, "hour") || a(e, c, "minute") || a(e, s, "second") || e + " ms"
            }
        ...
        23: [function(e, t, n) {
            ...
            t.exports = function(e) {
                ...
                return n != -1 && o != -1 && (s.source = t, s.host = s.host.substring(1, s.host.length - 1).replace(/;/g, ":"),
                    s.authority = s.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), s.ipv6uri = !0), s
            }
        }, {}],
        24: [function(e, t, n) {
            function r(e, t, n) {
        ...
        25: [function(e, t, n) {
            (function(t) {
                ...
                n.encodePacket = function(e, n, o, s) {
                    ...
                    var d = v[e.type];
                    return void 0 !== e.data && (d += o ? f.encode(String(e.data)) : String(e.data)), s("" + d)
                    ...
                    for (var i = e, o = [], a = !1; i.byteLength > 0;) {
                        for (var s = new Uint8Array(i), c = 0 === s[0], d = "", u = 1; 255 != s[u]; u++) {
                            if (d.length > 310) {
                                a = !0;
                                break
                            }
            ...
            t.exports = function(e, t) {
                ...
                if (window.navigator.userAgent.match("Chrome")) {
                    ...
                    if (window.navigator.userAgent.match("Linux") && (c = 35), sessionStorage.getScreenMediaJSExtensionId) chrome.runtime.sendMessage(sessionStorage.getScreenMediaJSExtensionId, {
                        ...
                        i[p] = [a, o ? e : null], window.postMessage({
                            type: "getScreen",
                            id: p
                        }, "*")
                    }
        ...
        37: [function(t, n, r) {
            ! function(t) {
                ...
                p && d ? (p.stringify = d.stringify, p.parse = d.parse) : p = t.JSON = d || {};
                var u = new Date(-0xc782b5b800cec);
                try {
                    u = u.getUTCFullYear() == -109252 && 0 === u.getUTCMonth() && 1 === u.getUTCDate() && 10 == u.getUTCHours() && 37 == u.getUTCMinutes() && 6 == u.getUTCSeconds() && 708 == u.getUTCMilliseconds()
                } catch (e) {}
                if (!n("json")) {
                    ...
                    if (o = function(e, t) {
                        ...
                        var T = {
                            ...
                            O = function(e, t, n, r, c, d, p) {
                                var u, l, y, b, S, k, T, E, P, D, _, j, M, A, I, L;
                                try {
                                    u = t[e]
                                } catch (e) {}
                                if ("object" == typeof u && u)
                                    if (l = s.call(u), l != f || i.call(u, "toJSON")) "function" == typeof u.toJSON && (l != h && l != m && l != g || i.call(u, "toJSON")) && (u = u.toJSON(e));
                                    else if (u > -1 / 0 && u < 1 / 0) {
                                    if (C) {
                                        for (S = w(u / 864e5), y = w(S / 365.2425) + 1970 - 1; C(y + 1, 0) <= S; y++);
                                        for (b = w((S - C(y, 0)) / 30.42); C(y, b + 1) <= S; b++);
                                        S = 1 + S - C(y, b), k = (u % 864e5 + 864e5) % 864e5, T = w(k / 36e5) % 24, E = w(k / 6e4) % 60, P = w(k / 1e3) % 60, D = k % 1e3
                                    } else y = u.getUTCFullYear(), b = u.getUTCMonth(), S = u.getUTCDate(), T = u.getUTCHours(), E = u.getUTCMinutes(), P = u.getUTCSeconds(), D = u.getUTCMilliseconds();
                                    u = (y <= 0 || y >= 1e4 ? (y < 0 ? "-" : "+") + R(6, y < 0 ? -y : y) : R(4, y)) + "-" + R(2, b + 1) + "-" + R(2, S) + "T" + R(2, T) + ":" + R(2, E) + ":" + R(2, P) + "." + R(3, D) + "Z"
                                } else u = null;
                                if (n && (u = n.call(t, e, u)), null === u) return "null";
                                if (l = s.call(u), l == v) return "" + u;
                                if (l == h) return u > -1 / 0 && u < 1 / 0 ? "" + u : "null";
                                if (l == m) return x("" + u);
                                if ("object" == typeof u) {
                                    for (A = p.length; A--;)
                                        if (p[A] === u) throw TypeError();
                                    if (p.push(u), _ = [], I = d, d += c, l == g) {
                                        for (M = 0, A = u.length; M < A; M++) j = O(M, u, n, r, c, d, p), _.push(j === a ? "null" : j);
                                        L = _.length ? c ? "[\n" + d + _.join(",\n" + d) + "\n" + I + "]" : "[" + _.join(",") + "]" : "[]"
                                    } else o(r || u, function(e) {
                                        var t = O(e, u, n, r, c, d, p);
                                        t !== a && _.push(x(e) + ":" + (c ? " " : "") + t)
                                    }), L = _.length ? c ? "{\n" + d + _.join(",\n" + d) + "\n" + I + "}" : "{" + _.join(",") + "}" : "{}";
                                    return p.pop(), L
                                }
                        ...
                        p.stringify = function(e, t, n) {
                            ...
                            if ("function" == typeof t || "object" == typeof t && t)
                                ...
                                o = {};
                                for (var c, d = 0, p = t.length; d < p; c = t[d++], a = s.call(c), (a == m || a == h) && (o[c] = 1));
                            }
                            if (n)
                                if ((a = s.call(n)) == h) {
                                    if ((n -= n % 1) > 0)
                    ...
                    if (!n("json-parse")) {
                        var D, _, j = String.fromCharCode,
                            ...
                            I = function() {
                                for (var e, t, n, r, i, o = _, a = o.length; D < a;) switch (i = o.charCodeAt(D)) {
                                    case 9:
                                    case 10:
                                    case 13:
                                    case 32:
                        ...
                        p.parse = function(e, t) {
                            var n, r;
                            return D = 0, _ = "" + e, n = L(I()), "$" != I() && A(), D = _ = null, t && s.call(t) == l ? B((r = {}, r[""] = n, r), "", t) : n
                        }
                    }
                }
                c && e(function() {
        ...
        38: [function(e, t, n) {
            ...
            i.inherits(r, d), r.prototype.start = function(e, t) {
                ...
                s(r, function(e, i) {
                    ...
                    } else r.audio && n.config.detectSpeakingEvents && n.setupAudioMonitor(i, n.config.harkOptions), n.localStreams.push(i), n.config.autoAdjustMic && (n.gainController = new p(i), n.setMicIfEnabled(.5)), i.onended = function() {}, n.emit("localStream", i);
                    if (t) return t(e, i)
                })
            ...
            (function(e) {
                ...
                function B(e, t) {
                    var n = $t(e) || ye(e) ? c(e.length, String) : [],
                        r = n.length,
                        i = !!r;
                    for (var o in e) !t && !Ct.call(e, o) || i && ("length" == o || ue(o, r)) || n.push(o);
                    return n
                }
                ...
                function z(e, t, n, r, i, a, s) {
                    ...
                    if (d) {
                        ...
                        if (u == Fe || u == _e || l && !a) {
                            if (p(e)) return a ? e : {};
                            if (c = de(l ? {} : e), !t) return ie(e, G(c, e))
                        } else {
                            if (!ct[u]) return a ? e : {};
                            c = pe(e, u, z, t)
                        }
                ...
                function H(e) {
                    if (!ke(e) || fe(e)) return !1;
                    var t = Ce(e) || p(e) ? kt : at;
                    return t.test(me(e))
                }
                ...
                function de(e) {
                    return "function" != typeof e.constructor || he(e) ? {} : V(Pt(e))
                }
                ...
                function ye(e) {
                    return be(e) && Ct.call(e, "callee") && (!Ot.call(e, "callee") || St.call(e) == _e)
                }
                ...
                var xe = 200,
                    ...
                    st = /^(?:0|[1-9]\d*)$/,
                    ct = {};
                ct[_e] = ct[je] = ct[We] = ct[Xe] = ct[Me] = ct[Ae] = ct[$e] = ct[Ye] = ct[Ke] = ct[Ze] = ct[Qe] = ct[Be] = ct[Ue] = ct[Fe] = ct[ze] = ct[Ve] = ct[Je] = ct[qe] = ct[et] = ct[tt] = ct[nt] = ct[rt] = !0, ct[Ie] = ct[Le] = ct[He] = !1;
                var dt = "object" == typeof e && e && e.Object === Object && e,
                    pt = "object" == typeof self && self && self.Object === Object && self,
                    ut = dt || pt || Function("return this")(),
                    lt = "object" == typeof n && n && !n.nodeType && n,
                    ft = lt && "object" == typeof t && t && !t.nodeType && t,
                    ht = ft && ft.exports === lt,
                    mt = Array.prototype,
                    ...
                    Tt = ht ? ut.Buffer : void 0,
                    Et = ut.Symbol,
                    Rt = ut.Uint8Array,
                    Pt = l(Object.getPrototypeOf, Object),
                    xt = Object.create,
                    Ot = vt.propertyIsEnumerable,
                    Dt = mt.splice,
                    _t = Object.getOwnPropertySymbols,
                    jt = Tt ? Tt.isBuffer : void 0,
                    Mt = l(Object.keys, Object),
                    At = se(ut, "DataView"),
                    It = se(ut, "Map"),
                    Lt = se(ut, "Promise"),
                    Nt = se(ut, "Set"),
                ...
                h.prototype.clear = m, h.prototype.delete = g, h.prototype.get = v, h.prototype.has = y, h.prototype.set = w, b.prototype.clear = C, b.prototype.delete = S, b.prototype.get = k, b.prototype.has = T, b.prototype.set = E, R.prototype.clear = P, R.prototype.delete = x, R.prototype.get = O, R.prototype.has = D, R.prototype.set = _, j.prototype.clear = M, j.prototype.delete = A, j.prototype.get = I, j.prototype.has = L, j.prototype.set = N;
                var Wt = _t ? l(_t, Object) : Re,
                    Xt = q;
        ...
        41: [function(e, t, n) {
            ...
            t.exports = {
                ...
                supportWebAudio: !(!p || !p.prototype.createMediaStreamSource),
                ...
                webAudio: !(!p || !p.prototype.createMediaStreamSource),
        ...
        47: [function(e, t, n) {
            ...
            }, f.title = "browser", f.browser = !0, f.env = {}, f.argv = [], f.version = "", f.versions = {}, f.on = p, f.addListener = p, f.once = p, f.off = p, f.removeListener = p, f.removeAllListeners = p, f.emit = p, f.binding = function(e) {
                    ...
                    shimPeerConnection: function() {
                        window.RTCIceGatherer && (window.RTCIceCandidate || (window.RTCIceCandidate = function(e) {
                            ...
                            if ("offer" === e.type) this._pendingOffer && (t = r.splitSections(e.sdp), n = t.shift(), t.forEach(function(e, t) {
                                ...
                                t.forEach(function(e, t) {
                                    ...
                                    if (!l && !a.isDatachannel) {
                                        ...
                                        o && (m.role = "server"), i.usingBundle && 0 !== t || (c.start(s, f, o ? "controlling" : "controlled"), d.start(m));
                                        var g = i._getCommonCapabilities(p, u);
                            ...
                            switch (this.usingBundle = r.matchPrefix(a, "a=group:BUNDLE ").length > 0, o.forEach(function(o, c) {
                                ...
                                if (h = h.length ? h[0].substr(6) : r.generateIdentifier(), "application" === u && "DTLS/SCTP" === p[2]) return void(t.transceivers[c] = {
                                    mid: h,
                                    isDatachannel: !0
                                });
                                var m, g, v, y, w, b, C, S, k, T, E, R, P = r.parseRtpParameters(o);
                                l || (E = r.getIceParameters(o, a), R = r.getDtlsParameters(o, a), R.role = "client"), S = r.parseRtpEncodingParameters(o);
                                ...
                                var D = r.matchPrefix(o, "a=end-of-candidates", a).length > 0,
                                    _ = r.matchPrefix(o, "a=candidate:").map(function(e) {
                                        return r.parseCandidate(e)
                                    }).filter(function(e) {
                                        return "1" === e.component
                                    });
                                if ("offer" !== e.type || l) "answer" !== e.type || l || (m = t.transceivers[c], g = m.iceGatherer, v = m.iceTransport, y = m.dtlsTransport, w = m.rtpSender, b = m.rtpReceiver, C = m.sendEncodingParameters, k = m.localCapabilities, t.transceivers[c].recvEncodingParameters = S, t.transceivers[c].remoteCapabilities = P, t.transceivers[c].cname = x, (s || D) && _.length && v.setRemoteCandidates(_), t.usingBundle && 0 !== c || (v.start(g, E, "controlling"), y.start(R)), t._transceive(m, "sendrecv" === f || "recvonly" === f, "sendrecv" === f || "sendonly" === f), !b || "sendrecv" !== f && "sendonly" !== f ? delete m.rtpReceiver : (T = b.track, i.push([T, b]), n.addTrack(T)));
                                else {
                                    ...
                                    if (D && j.iceTransport.setRemoteCandidates(_), k = RTCRtpReceiver.getCapabilities(u), C = [{
                                            ssrc: 1001 * (2 * c + 2)
                                        }], b = new RTCRtpReceiver(j.dtlsTransport, u), T = b.track, i.push([T, b]), n.addTrack(T), t.localStreams.length > 0 && t.localStreams[0].getTracks().length >= c) {
                                        var M;
                                        "audio" === u ? M = t.localStreams[0].getAudioTracks()[0] : "video" === u && (M = t.localStreams[0].getVideoTracks()[0]), M && (w = new RTCRtpSender(M, j.dtlsTransport))
                                    }
                                    t.transceivers[c] = {
                            ...
                            n.forEach(function(t, n) {
                                var i, o, a = t.track,
                                    ...
                                    u = RTCRtpSender.getCapabilities(c),
                                    l = [{
                                        ssrc: 1001 * (2 * n + 1)
                                    }];
                                a && (i = new RTCRtpSender(a, p.dtlsTransport)), t.wantReceive && (o = new RTCRtpReceiver(p.dtlsTransport, c)), s[n] = {
            ...
            i.inherits(r, a), Object.defineProperty(r.prototype, "signalingState", {
                ...
                return "closed" === this.pc.signalingState ? t("Already closed") : void n.pc.createAnswer(function(e) {
                    ...
                    n._candidateBuffer = [], n.pc.setLocalDescription(e, function() {
                        ...
                        if (n.enableChromeNativeSimulcast && (p.jingle || (p.jingle = o.toSessionJSON(e.sdp, {
                                role: n._role(),
                                direction: "outgoing"
        ...
        61: [function(e, t, n) {
            ...
            n._setIdCounter = function(e) {
                ...
                var d = c.shift() + "\r\n",
                    ...
                    u = {},
                    l = [];
                for (r = 0; r < c.length; r++) l.push(n.toMediaJSON(c[r], d, {
                    role: a,
                    direction: s,
                ...
                if (m && (l.name = m.substr(6)), i.findLine("a=sendrecv", d, p) ? l.senders = "both" : i.findLine("a=sendonly", d, p) ? l.senders = r[s][c].sendonly : i.findLine("a=recvonly", d, p) ? l.senders = r[s][c].recvonly : i.findLine("a=inactive", d, p) && (l.senders = "none"), "rtp" == f.applicationType) {
                    ...
                    var w = i.findLines("a=crypto:", d, p);
                    w.forEach(function(e) {
                        f.encryption.push(i.crypto(e))
                    }), i.findLine("a=rtcp-mux", d) && (f.mux = !0);
                    ...
                    i.findLine("a=x-google-flag:conference", d, p) && (f.googConferenceFlag = !0)
                }
                var P = i.findLines("a=fingerprint:", d, p),
                    x = i.findLine("a=setup:", d, p);
                P.forEach(function(e) {
                    var t = i.fingerprint(e);
                    x && (t.setup = x.substr(8)), h.fingerprints.push(t)
                });
                var O = i.findLine("a=ice-ufrag:", d, p),
                    D = i.findLine("a=ice-pwd:", d, p);
                if (O && D) {
                    h.ufrag = O.substr(12), h.pwd = D.substr(10), h.candidates = [];
                    var _ = i.findLines("a=candidate:", d, p);
                    _.forEach(function(e) {
                        h.candidates.push(n.toCandidateJSON(e))
                    })
                }
                if ("datachannel" == f.applicationType) {
                    var j = i.findLines("a=sctpmap:", d);
        ...
        62: [function(e, t, n) {
            ...
            n.toSessionSDP = function(e, t) {
                ...
                if ("datachannel" == s.applicationType ? (u.push("application"), u.push("1"), u.push("DTLS/SCTP"), c.sctp && c.sctp.forEach(function(e) {
                        u.push(e.number)
                    })) : (u.push(s.media), u.push("1"), p.length > 0 ? u.push("UDP/TLS/RTP/SAVPF") : s.encryption && s.encryption.length > 0 ? u.push("RTP/SAVPF") : u.push("RTP/AVPF"), d.forEach(function(e) {
                        u.push(e.id)
                    })), i.push("m=" + u.join(" ")),
                    i.push("c=IN IP4 0.0.0.0"), s.bandwidth && s.bandwidth.type && s.bandwidth.bandwidth && i.push("b=" + s.bandwidth.type + ":" + s.bandwidth.bandwidth), "rtp" == s.applicationType && i.push("a=rtcp:1 IN IP4 0.0.0.0"), c) {
        ...
        66: [function(e, t, n) {
            ...
            var i = (e("./url"), e("engine.io-client")),
                ...
                c = e("./on"),
                d = e("component-bind"),
                p = (e("object-component"), e("debug")("socket.io-client:manager")),
                u = e("indexof"),
                l = e("backo2");
            t.exports = r, r.prototype.emitAll = function() {
                ...
                var r = c(t, "open", function() {
                    ...
                    o = c(t, "error", function(t) {
                        if (p("connect_error"), n.cleanup(), n.readyState = "closed", n.emitAll("connect_error", t), e) {
                ...
                if (!1 !== this._timeout) {
                    ...
                    var s = setTimeout(function() {
                        p("connect attempt timed out after %d", a), r.destroy(), t.close(), t.emit("error", "timeout"), n.emitAll("connect_timeout", a)
                    }, a);
                    this.subs.push({
                        destroy: function() {
                            clearTimeout(s)
                ...
                p("close"), this.cleanup(), this.backoff.reset(), this.readyState = "closed", this.emit("close", e), this._reconnection && !this.skipReconnect && this.reconnect()
        ...
        68: [function(e, t, n) {
            ...
            o(r.prototype), r.prototype.subEvents = function() {
                ...
                var t = e.data || [];
                d("emitting event %j", t), null != e.id && (d("attaching ack callback to event"), t.push(this.ack(e.id))), this.connected ? l.apply(this, t) : this.receiveBuffer.push(t)
        ...
        72: [function(e, t, n) {
            ...
            function i(e) {
                var t = "",
                    r = !1;
                return t += e.type, n.BINARY_EVENT != e.type && n.BINARY_ACK != e.type || (t += e.attachments, t += "-"), e.nsp && "/" != e.nsp && (r = !0, t += e.nsp), null != e.id && (r && (t += ",", r = !1), t += e.id), null != e.data && (r && (t += ","), t += u.stringify(e.data)), p("encoded %j as %s", e, t), t
            }
            ...
            (function(t) {
                ! function(i) {
                    ...
                    function l() {
                        ...
                        if (240 == (248 & e) && (t = u(), n = u(), r = u(), i = (15 & e) << 18 | t << 12 | n << 6 | r, i >= 65536 && i <= 1114111)) return i;
        ...
        81: [function(e, t, n) {
            (function(t, r) {
                ...
                function c(e, t, r) {
                    if (e.customInspect && t && R(t.inspect) && t.inspect !== n.inspect && (!t.constructor || t.constructor.prototype !== t)) {
                        var i = t.inspect(r, e);
                    ...
                    var a = Object.keys(t),
                        m = s(a);
                    if (e.showHidden && (a = Object.getOwnPropertyNames(t)), E(t) && (a.indexOf("message") >= 0 || a.indexOf("description") >= 0)) return p(t);
                    if (0 === a.length) {
                        if (R(t)) {
                            var g = t.name ? ": " + t.name : "";
                    ...
                    if (S(t) && (v = " " + RegExp.prototype.toString.call(t)), T(t) && (v = " " + Date.prototype.toUTCString.call(t)), E(t) && (v = " " + p(t)), 0 === a.length && (!y || 0 == t.length)) return b[0] + v + b[1];
                ...
                function u(e, t, n, r, i) {
                    for (var o = [], a = 0, s = t.length; a < s; ++a) _(t, String(a)) ? o.push(l(e, t, n, r, String(a), !0)) : o.push("");
                ...
                function l(e, t, n, r, i, o) {
                    ...
                    if (d = Object.getOwnPropertyDescriptor(t, i) || {
                            value: t[i]
                        }, d.get ? s = d.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : d.set && (s = e.stylize("[Setter]", "special")), _(r, i) || (a = "[" + i + "]"), s || (e.seen.indexOf(d.value) < 0 ? (s = g(n) ? c(e, d.value, null) : c(e, d.value, n - 1), s.indexOf("\n") > -1 && (s = o ? s.split("\n").map(function(e) {
                            return "  " + e
                        }).join("\n").substr(2) : "\n" + s.split("\n").map(function(e) {
                            return "   " + e
                ...
                n.debuglog = function(e) {
                    if (C(M) && (M = t.env.NODE_DEBUG || ""), e = e.toUpperCase(), !A[e])
                    ...
                    date: "magenta",
                    regexp: "red"
                }, n.isArray = h, n.isBoolean = m, n.isNull = g, n.isNullOrUndefined = v, n.isNumber = y, n.isString = w, n.isSymbol = b, n.isUndefined = C, n.isRegExp = S, n.isObject = k, n.isDate = T, n.isError = E, n.isFunction = R, n.isPrimitive = P, n.isBuffer = e("./support/isBuffer");
        ...
        82: [function(e, t, n) {
            ...
            "./chrome/chrome_shim": 83,
            "./edge/edge_shim": 85,
            "./firefox/firefox_shim": 87,
            "./safari/safari_shim": 89,
            "./utils": 90,
            dup: 48
        }],
        83: [function(e, t, n) {
                    ...
                    shimPeerConnection: function() {
                        window.RTCIceGatherer && (window.RTCIceCandidate || (window.RTCIceCandidate = function(e) {
                            ...
                            var t = this,
                                ...
                                s = r.matchPrefix(a, "a=ice-lite").length > 0;
                            switch (this.usingBundle = r.matchPrefix(a, "a=group:BUNDLE ").length > 0, o.forEach(function(o, c) {
                                var d, p, u, l, f, h, m, g, v, y, w, b, C = r.splitLines(o),
                                ...
                                if ("offer" !== e.type || T) "answer" !== e.type || T || (d = t.transceivers[c], p = d.iceGatherer, u = d.iceTransport, l = d.dtlsTransport, f = d.rtpSender, h = d.rtpReceiver, m = d.sendEncodingParameters, v = d.localCapabilities, t.transceivers[c].recvEncodingParameters = g, t.transceivers[c].remoteCapabilities = R, t.transceivers[c].cname = x, (s || D) && _.length && u.setRemoteCandidates(_), t.usingBundle && 0 !== c || (u.start(p, w, "controlling"), l.start(b)), t._transceive(d, "sendrecv" === E || "recvonly" === E, "sendrecv" === E || "sendonly" === E), !h || "sendrecv" !== E && "sendonly" !== E ? delete d.rtpReceiver : (y = h.track, i.push([y, h]), n.addTrack(y)));
                                else {
                                    var j = t.usingBundle && c > 0 ? {
                                        iceGatherer: t.transceivers[0].iceGatherer,
                                        iceTransport: t.transceivers[0].iceTransport,
                                        dtlsTransport: t.transceivers[0].dtlsTransport
                                    } : t._createIceAndDtlsTransports(P, c);
                                    if (D && j.iceTransport.setRemoteCandidates(_), v = RTCRtpReceiver.getCapabilities(k), m = [{
                                            ssrc: 1001 * (2 * c + 2)
                                        }], h = new RTCRtpReceiver(j.dtlsTransport, k), y = h.track, i.push([y, h]), n.addTrack(y), t.localStreams.length > 0 && t.localStreams[0].getTracks().length >= c) {
                                        var M = t.localStreams[0].getTracks()[c];
                                        f = new RTCRtpSender(M, j.dtlsTransport)
                                    }
                                    t.transceivers[c] = {
                                        iceGatherer: j.iceGatherer,
                                        iceTransport: j.iceTransport,
                    ...
                    detectBrowser: function() {
                        ...
                        if (navigator.mozGetUserMedia) e.browser = "firefox", e.version = this.extractVersion(navigator.userAgent, /Firefox\/([0-9]+)\./, 1), e.minVersion = 31;
                            ...
                            if (window.webkitRTCPeerConnection) e.browser = "chrome", e.version = this.extractVersion(navigator.userAgent, /Chrom(e|ium)\/([0-9]+)\./, 2), e.minVersion = 38;
                                ...
                                if (!navigator.userAgent.match(/Version\/(\d+).(\d+)/)) return e.browser = "Unsupported webkit-based browser with GUM support but no WebRTC support.",
                                    e;
        ...
        94: [function(e, t, n) {
            function r(e) {
                ...
                for (t in p) p.hasOwnProperty(t) && (this.config[t] = p[t]);
