...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2016 at 08:33 AM
...
INSERT INTO `fp_applicants` (`id`, `job_id`, `name`, `email`, `phone`, `skype`, `resume`, `photo`, `password`, `remember_token`, `created_at`, `updated_at`, `notes`, `hired`, `criteria`) VALUES
...
(118, 18, 'employee', 'applicant', 4, 'Test 11\r\n', '2016-08-23 05:38:33', '2016-08-23 05:38:33'),
(119, 18, 'employee', 'applicant', 4, 'Test 12', '2016-09-12 06:39:15', '2016-09-12 06:39:15');
...
--
-- Table structure for table `fp_discussions`
--

CREATE TABLE IF NOT EXISTS `fp_discussions` (
`id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `fp_discussions`
--

INSERT INTO `fp_discussions` (`id`, `owner_id`, `company_id`, `room_name`, `room_type`, `created_at`, `updated_at`) VALUES
(1, 18, 18, 'Test', 'public', '2016-10-24 05:26:47', '2016-10-24 05:26:47'),
(2, 18, 18, 'Test 2', 'public', '2016-10-24 05:27:06', '2016-10-24 05:27:06'),
(3, 18, 18, 'Test 3', 'public', '2016-10-24 05:28:20', '2016-10-24 06:21:48'),
(4, 18, 18, 'Test 4', 'private', '2016-10-24 06:01:31', '2016-10-24 06:01:31');
...
INSERT INTO `fp_jobs` (`id`, `user_id`, `company_id`, `title`, `description`, `photo`, `created_at`, `updated_at`, `notes`, `criteria`) VALUES
(10, 18, 1, 'Testing 1', 'Testing 1', 'assets/job\\company_logo_2.jpg', '2016-05-23 06:02:59', '2016-10-13 04:22:17', '<p>TestingTestingTestingTesting</p>\r\n\r\n<p>TestingTestingTestingTesting</p>\r\n\r\n<p>TestingTestingTestingTesting</p>\r\n\r\n<p>TestingTestingTestingTesting</p>\r\n', '<p>Teset</p>\r\n'),
...
--
-- Table structure for table `fp_links_order`
--

CREATE TABLE IF NOT EXISTS `fp_links_order` (
`id` int(10) unsigned NOT NULL,
  `task_id` int(11) NOT NULL,
  `company_id` int(11) NOT NULL,
  `links_order` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=9443 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(9434, 'default', '{"job":"mailer@handleQueuedMessage","data":{"view":"user.forgotPassword","data":{"email":"jexterdeanbuenaventura@gmail.com","password":"c7a33"},"callback":"C:32:\\"SuperClosure\\\\SerializableClosure\\":261:{a:5:{s:4:\\"code\\";s:122:\\"function ($message) {\\n    $message->to(\\\\Input::get(''email''), ''Forgot Password'')->subject(''Forgot Password Reset Link'');\\n};\\";s:7:\\"context\\";a:0:{}s:7:\\"binding\\";N;s:5:\\"scope\\";s:38:\\"App\\\\Http\\\\Controllers\\\\ProfileController\\";s:8:\\"isStatic\\";b:0;}}"}}', 255, 0, NULL, 1477400485, 1477400485),
(9435, 'default', '{"job":"mailer@handleQueuedMessage","data":{"view":"user.forgotPassword","data":{"email":"jexterdeanbuenaventura@gmail.com","password":"3adba"},"callback":"C:32:\\"SuperClosure\\\\SerializableClosure\\":261:{a:5:{s:4:\\"code\\";s:122:\\"function ($message) {\\n    $message->to(\\\\Input::get(''email''), ''Forgot Password'')->subject(''Forgot Password Reset Link'');\\n};\\";s:7:\\"context\\";a:0:{}s:7:\\"binding\\";N;s:5:\\"scope\\";s:38:\\"App\\\\Http\\\\Controllers\\\\ProfileController\\";s:8:\\"isStatic\\";b:0;}}"}}', 255, 0, NULL, 1477400487, 1477400487),
(9436, 'default', '{"job":"mailer@handleQueuedMessage","data":{"view":"emails.commentEmail","data":{"from_email":"::entity::|App\\\\Models\\\\User|19","to_email":"::entity::|App\\\\Models\\\\User|62","comment":"Test"},"callback":"C:32:\\"SuperClosure\\\\SerializableClosure\\":5031:{a:5:{s:4:\\"code\\";s:269:\\"function ($message) use($from_email, $to_email) {\\n    $message->from($from_email->email, $from_email->name);\\n    $message->to($to_email->email, $to_email->name);\\n    \\/\\/$message->to([''jobtcmailer@gmail.com''],$to_email->name);\\n    $message->subject($from_email->name);\\n};\\";s:7:\\"context\\";a:2:{s:10:\\"from_email\\";O:15:\\"App\\\\Models\\\\User\\":25:{s:11:\\"\\u0000*\\u0000fillable\\";a:18:{i:0;s:5:\\"email\\";i:1;s:8:\\"password\\";i:2;s:4:\\"name\\";i:3;s:5:\\"phone\\";i:4;s:5:\\"photo\\";i:5;s:6:\\"resume\\";i:6;s:9:\\"address_1\\";i:7;s:9:\\"address_2\\";i:8;s:7:\\"zipcode\\";i:9;s:10:\\"country_id\\";i:10;s:11:\\"user_status\\";i:11;s:5:\\"notes\\";i:12;s:5:\\"skype\\";i:13;s:8:\\"facebook\\";i:14;s:8:\\"linkedin\\";i:15;s:11:\\"timezone_id\\";i:16;s:14:\\"ticketit_admin\\";i:17;s:14:\\"ticketit_agent\\";}s:13:\\"\\u0000*\\u0000primaryKey\\";s:7:\\"user_id\\";s:8:\\"\\u0000*\\u0000table\\";s:4:\\"user\\";s:9:\\"\\u0000*\\u0000hidden\\";a:2:{i:0;s:8:\\"password\\";i:1;s:14:\\"remember_token\\";}s:13:\\"\\u0000*\\u0000connection\\";N;s:10:\\"\\u0000*\\u0000perPage\\";i:15;s:12:\\"incrementing\\";b:1;s:10:\\"timestamps\\";b:1;s:13:\\"\\u0000*\\u0000attributes\\";a:21:{s:7:\\"user_id\\";i:19;s:8:\\"password\\";s:60:\\"$2y$10$fwiJSpCfIwXrIWr8NJjNfeMcSP\\/\\/2KyjevUbWIrCUVCe4hKdL3Q3y\\";s:4:\\"name\\";s:8:\\"Jane Doe\\";s:5:\\"email\\";s:17:\\"janedoe@gmail.com\\";s:5:\\"phone\\";s:10:\\"1234567890\\";s:5:\\"photo\\";s:22:\\"assets\\/user\\/avatar.png\\";s:6:\\"resume\\";N;s:9:\\"address_1\\";s:0:\\"\\";s:9:\\"address_2\\";s:0:\\"\\";s:7:\\"zipcode\\";s:0:\\"\\";s:10:\\"country_id\\";s:3:\\"185\\";s:5:\\"skype\\";s:0:\\"\\";s:8:\\"facebook\\";s:0:\\"\\";s:8:\\"linkedin\\";s:0:\\"\\";s:11:\\"user_status\\";s:6:\\"Active\\";s:5:\\"notes\\";N;s:14:\\"remember_token\\";s:60:\\"U1rOOtMOfdTCLNDvMSZkeOgKltj3dXuO8CqVX1DlfURifQwnkUM48FJo7tUZ\\";s:10:\\"created_at\\";s:19:\\"2016-06-27 23:43:18\\";s:10:\\"updated_at\\";s:19:\\"2016-06-27 15:43:18\\";s:14:\\"ticketit_admin\\";i:1;s:14:\\"ticketit_agent\\";i:1;}s:11:\\"\\u0000*\\u0000original\\";a:21:{s:7:\\"user_id\\";i:19;s:8:\\"password\\";s:60:\\"$2y$10$fwiJSpCfIwXrIWr8NJjNfeMcSP\\/\\/2KyjevUbWIrCUVCe4hKdL3Q3y\\";s:4:\\"name\\";s:8:\\"Jane Doe\\";s:5:\\"email\\";s:17:\\"janedoe@gmail.com\\";s:5:\\"phone\\";s:10:\\"1234567890\\";s:5:\\"photo\\";s:22:\\"assets\\/user\\/avatar.png\\";s:6:\\"resume\\";N;s:9:\\"address_1\\";s:0:\\"\\";s:9:\\"address_2\\";s:0:\\"\\";s:7:\\"zipcode\\";s:0:\\"\\";s:10:\\"country_id\\";s:3:\\"185\\";s:5:\\"skype\\";s:0:\\"\\";s:8:\\"facebook\\";s:0:\\"\\";s:8:\\"linkedin\\";s:0:\\"\\";s:11:\\"user_status\\";s:6:\\"Active\\";s:5:\\"notes\\";N;s:14:\\"remember_token\\";s:60:\\"U1rOOtMOfdTCLNDvMSZkeOgKltj3dXuO8CqVX1DlfURifQwnkUM48FJo7tUZ\\";s:10:\\"created_at\\";s:19:\\"2016-06-27 23:43:18\\";s:10:\\"updated_at\\";s:19:\\"2016-06-27 15:43:18\\";s:14:\\"ticketit_admin\\";i:1;s:14:\\"ticketit_agent\\";i:1;}s:12:\\"\\u0000*\\u0000relations\\";a:0:{}s:10:\\"\\u0000*\\u0000visible\\";a:0:{}s:10:\\"\\u0000*\\u0000appends\\";a:0:{}s:10:\\"\\u0000*\\u0000guarded\\";a:1:{i:0;s:1:\\"*\\";}s:8:\\"\\u0000*\\u0000dates\\";a:0:{}s:13:\\"\\u0000*\\u0000dateFormat\\";N;s:8:\\"\\u0000*\\u0000casts\\";a:0:{}s:10:\\"\\u0000*\\u0000touches\\";a:0:{}s:14:\\"\\u0000*\\u0000observables\\";a:0:{}s:7:\\"\\u0000*\\u0000with\\";a:0:{}s:13:\\"\\u0000*\\u0000morphClass\\";N;s:6:\\"exists\\";b:1;s:18:\\"wasRecentlyCreated\\";b:0;s:8:\\"\\u0000*\\u0000roles\\";N;s:14:\\"\\u0000*\\u0000permissions\\";N;}s:8:\\"to_email\\";O:15:\\"App\\\\Models\\\\User\\":25:{s:11:\\"\\u0000*\\u0000fillable\\";a:18:{i:0;s:5:\\"email\\";i:1;s:8:\\"password\\";i:2;s:4:\\"name\\";i:3;s:5:\\"phone\\";i:4;s:5:\\"photo\\";i:5;s:6:\\"resume\\";i:6;s:9:\\"address_1\\";i:7;s:9:\\"address_2\\";i:8;s:7:\\"zipcode\\";i:9;s:10:\\"country_id\\";i:10;s:11:\\"user_status\\";i:11;s:5:\\"notes\\";i:12;s:5:\\"skype\\";i:13;s:8:\\"facebook\\";i:14;s:8:\\"linkedin\\";i:15;s:11:\\"timezone_id\\";i:16;s:14:\\"ticketit_admin\\";i:17;s:14:\\"ticketit_agent\\";}s:13:\\"\\u0000*\\u0000primaryKey\\";s:7:\\"user_id\\";s:8:\\"\\u0000*\\u0000table\\";s:4:\\"user\\";s:9:\\"\\u0000*\\u0000hidden\\";a:2:{i:0;s:8:\\"password\\";i:1;s:14:\\"remember_token\\";}s:13:\\"\\u0000*\\u0000connection\\";N;s:10:\\"\\u0000*\\u0000perPage\\";i:15;s:12:\\"incrementing\\";b:1;s:10:\\"timestamps\\";b:1;s:13:\\"\\u0000*\\u0000attributes\\";a:21:{s:7:\\"user_id\\";i:62;s:8:\\"password\\";s:60:\\"$2y$10$3cbhEelwKAzARi9MtoU0JOws.5TC9i6d0g3gm1KZgF6cxaCaKQh3q\\";s:4:\\"name\\";s:13:\\"Tryste Gothel\\";s:5:\\"email\\";s:32:\\"jexterdeanbuenaventura@gmail.com\\";s:5:\\"phone\\";N;s:5:\\"photo\\";N;s:6:\\"resume\\";N;s:9:\\"address_1\\";N;s:9:\\"address_2\\";N;s:7:\\"zipcode\\";N;s:10:\\"country_id\\";N;s:5:\\"skype\\";N;s:8:\\"facebook\\";N;s:8:\\"linkedin\\";N;s:11:\\"user_status\\";s:6:\\"Active\\";s:5:\\"notes\\";N;s:14:\\"remember_token\\";s:0:\\"\\";s:10:\\"created_at\\";s:19:\\"2016-06-30 09:56:52\\";s:10:\\"updated_at\\";s:19:\\"2016-06-30 09:56:52\\";s:14:\\"ticketit_admin\\";i:0;s:14:\\"ticketit_agent\\";i:0;}s:11:\\"\\u0000*\\u0000original\\";a:21:{s:7:\\"user_id\\";i:62;s:8:\\"password\\";s:60:\\"$2y$10$3cbhEelwKAzARi9MtoU0JOws.5TC9i6d0g3gm1KZgF6cxaCaKQh3q\\";s:4:\\"name\\";s:13:\\"Tryste Gothel\\";s:5:\\"email\\";s:32:\\"jexterdeanbuenaventura@gmail.com\\";s:5:\\"phone\\";N;s:5:\\"photo\\";N;s:6:\\"resume\\";N;s:9:\\"address_1\\";N;s:9:\\"address_2\\";N;s:7:\\"zipcode\\";N;s:10:\\"country_id\\";N;s:5:\\"skype\\";N;s:8:\\"facebook\\";N;s:8:\\"linkedin\\";N;s:11:\\"user_status\\";s:6:\\"Active\\";s:5:\\"notes\\";N;s:14:\\"remember_token\\";s:0:\\"\\";s:10:\\"created_at\\";s:19:\\"2016-06-30 09:56:52\\";s:10:\\"updated_at\\";s:19:\\"2016-06-30 09:56:52\\";s:14:\\"ticketit_admin\\";i:0;s:14:\\"ticketit_agent\\";i:0;}s:12:\\"\\u0000*\\u0000relations\\";a:0:{}s:10:\\"\\u0000*\\u0000visible\\";a:0:{}s:10:\\"\\u0000*\\u0000appends\\";a:0:{}s:10:\\"\\u0000*\\u0000guarded\\";a:1:{i:0;s:1:\\"*\\";}s:8:\\"\\u0000*\\u0000dates\\";a:0:{}s:13:\\"\\u0000*\\u0000dateFormat\\";N;s:8:\\"\\u0000*\\u0000casts\\";a:0:{}s:10:\\"\\u0000*\\u0000touches\\";a:0:{}s:14:\\"\\u0000*\\u0000observables\\";a:0:{}s:7:\\"\\u0000*\\u0000with\\";a:0:{}s:13:\\"\\u0000*\\u0000morphClass\\";N;s:6:\\"exists\\";b:1;s:18:\\"wasRecentlyCreated\\";b:0;s:8:\\"\\u0000*\\u0000roles\\";N;s:14:\\"\\u0000*\\u0000permissions\\";N;}}s:7:\\"binding\\";N;s:5:\\"scope\\";s:38:\\"App\\\\Http\\\\Controllers\\\\CommentController\\";s:8:\\"isStatic\\";b:0;}}"}}', 255, 0, NULL, 1477400489, 1477400489),
(9437, 'default', '{"job":"mailer@handleQueuedMessage","data":{"view":"user.forgotPassword","data":{"email":"jexterdeanbuenaventura@gmail.com","password":"facd7"},"callback":"C:32:\\"SuperClosure\\\\SerializableClosure\\":261:{a:5:{s:4:\\"code\\";s:122:\\"function ($message) {\\n    $message->to(\\\\Input::get(''email''), ''Forgot Password'')->subject(''Forgot Password Reset Link'');\\n};\\";s:7:\\"context\\";a:0:{}s:7:\\"binding\\";N;s:5:\\"scope\\";s:38:\\"App\\\\Http\\\\Controllers\\\\ProfileController\\";s:8:\\"isStatic\\";b:0;}}"}}', 255, 0, NULL, 1477400491, 1477400491),
(9438, 'default', '{"job":"mailer@handleQueuedMessage","data":{"view":"emails.addParticipantEmail","data":{"from_email":"::entity::|App\\\\Models\\\\User|18","to_email":"jexterdeanbuenaventura@gmail.com"},"callback":"C:32:\\"SuperClosure\\\\SerializableClosure\\":3207:{a:5:{s:4:\\"code\\";s:182:\\"function ($message) use($from_email, $to_email) {\\n    $message->from($from_email->email, $from_email->name);\\n    $message->to($to_email);\\n    $message->subject($from_email->name);\\n};\\";s:7:\\"context\\";a:2:{s:10:\\"from_email\\";O:15:\\"App\\\\Models\\\\User\\":25:{s:11:\\"\\u0000*\\u0000fillable\\";a:18:{i:0;s:5:\\"email\\";i:1;s:8:\\"password\\";i:2;s:4:\\"name\\";i:3;s:5:\\"phone\\";i:4;s:5:\\"photo\\";i:5;s:6:\\"resume\\";i:6;s:9:\\"address_1\\";i:7;s:9:\\"address_2\\";i:8;s:7:\\"zipcode\\";i:9;s:10:\\"country_id\\";i:10;s:11:\\"user_status\\";i:11;s:5:\\"notes\\";i:12;s:5:\\"skype\\";i:13;s:8:\\"facebook\\";i:14;s:8:\\"linkedin\\";i:15;s:11:\\"timezone_id\\";i:16;s:14:\\"ticketit_admin\\";i:17;s:14:\\"ticketit_agent\\";}s:13:\\"\\u0000*\\u0000primaryKey\\";s:7:\\"user_id\\";s:8:\\"\\u0000*\\u0000table\\";s:4:\\"user\\";s:9:\\"\\u0000*\\u0000hidden\\";a:2:{i:0;s:8:\\"password\\";i:1;s:14:\\"remember_token\\";}s:13:\\"\\u0000*\\u0000connection\\";N;s:10:\\"\\u0000*\\u0000perPage\\";i:15;s:12:\\"incrementing\\";b:1;s:10:\\"timestamps\\";b:1;s:13:\\"\\u0000*\\u0000attributes\\";a:21:{s:7:\\"user_id\\";i:18;s:8:\\"password\\";s:60:\\"$2a$06$jtGr\\/GXKDi\\/DGzOHR6fRquvZqPKPTuHYDNOHk2wDSJlsBHjIAZjde\\";s:4:\\"name\\";s:24:\\"Jexter Dean Buenaventura\\";s:5:\\"email\\";s:26:\\"projectmanager@hdenergy.ca\\";s:5:\\"phone\\";s:10:\\"1234567890\\";s:5:\\"photo\\";s:35:\\"assets\\/user\\\\Snapshot_20160526_2.JPG\\";s:6:\\"resume\\";s:70:\\"assets\\/user\\/resumes\\\\Sample-Resume-Computer-Programmer-Entry-Level1.doc\\";s:9:\\"address_1\\";s:23:\\"#14 A Wakat Suello Road\\";s:9:\\"address_2\\";s:0:\\"\\";s:7:\\"zipcode\\";s:4:\\"2600\\";s:10:\\"country_id\\";s:3:\\"185\\";s:5:\\"skype\\";s:9:\\"arcblades\\";s:8:\\"facebook\\";s:10:\\"jexterdean\\";s:8:\\"linkedin\\";s:10:\\"jexterdean\\";s:11:\\"user_status\\";s:6:\\"Active\\";s:5:\\"notes\\";s:16:\\"<p>Testing<\\/p>\\r\\n\\";s:14:\\"remember_token\\";s:60:\\"ffCDBDfBnzgXghhFIuMyLqb417SFlPe8gpZkL14NdGzEk8hMdmSJwjWRHQkp\\";s:10:\\"created_at\\";s:19:\\"2016-10-24 22:40:26\\";s:10:\\"updated_at\\";s:19:\\"2016-10-24 14:40:26\\";s:14:\\"ticketit_admin\\";i:1;s:14:\\"ticketit_agent\\";i:0;}s:11:\\"\\u0000*\\u0000original\\";a:21:{s:7:\\"user_id\\";i:18;s:8:\\"password\\";s:60:\\"$2a$06$jtGr\\/GXKDi\\/DGzOHR6fRquvZqPKPTuHYDNOHk2wDSJlsBHjIAZjde\\";s:4:\\"name\\";s:24:\\"Jexter Dean Buenaventura\\";s:5:\\"email\\";s:26:\\"projectmanager@hdenergy.ca\\";s:5:\\"phone\\";s:10:\\"1234567890\\";s:5:\\"photo\\";s:35:\\"assets\\/user\\\\Snapshot_20160526_2.JPG\\";s:6:\\"resume\\";s:70:\\"assets\\/user\\/resumes\\\\Sample-Resume-Computer-Programmer-Entry-Level1.doc\\";s:9:\\"address_1\\";s:23:\\"#14 A Wakat Suello Road\\";s:9:\\"address_2\\";s:0:\\"\\";s:7:\\"zipcode\\";s:4:\\"2600\\";s:10:\\"country_id\\";s:3:\\"185\\";s:5:\\"skype\\";s:9:\\"arcblades\\";s:8:\\"facebook\\";s:10:\\"jexterdean\\";s:8:\\"linkedin\\";s:10:\\"jexterdean\\";s:11:\\"user_status\\";s:6:\\"Active\\";s:5:\\"notes\\";s:16:\\"<p>Testing<\\/p>\\r\\n\\";s:14:\\"remember_token\\";s:60:\\"ffCDBDfBnzgXghhFIuMyLqb417SFlPe8gpZkL14NdGzEk8hMdmSJwjWRHQkp\\";s:10:\\"created_at\\";s:19:\\"2016-10-24 22:40:26\\";s:10:\\"updated_at\\";s:19:\\"2016-10-24 14:40:26\\";s:14:\\"ticketit_admin\\";i:1;s:14:\\"ticketit_agent\\";i:0;}s:12:\\"\\u0000*\\u0000relations\\";a:0:{}s:10:\\"\\u0000*\\u0000visible\\";a:0:{}s:10:\\"\\u0000*\\u0000appends\\";a:0:{}s:10:\\"\\u0000*\\u0000guarded\\";a:1:{i:0;s:1:\\"*\\";}s:8:\\"\\u0000*\\u0000dates\\";a:0:{}s:13:\\"\\u0000*\\u0000dateFormat\\";N;s:8:\\"\\u0000*\\u0000casts\\";a:0:{}s:10:\\"\\u0000*\\u0000touches\\";a:0:{}s:14:\\"\\u0000*\\u0000observables\\";a:0:{}s:7:\\"\\u0000*\\u0000with\\";a:0:{}s:13:\\"\\u0000*\\u0000morphClass\\";N;s:6:\\"exists\\";b:1;s:18:\\"wasRecentlyCreated\\";b:0;s:8:\\"\\u0000*\\u0000roles\\";N;s:14:\\"\\u0000*\\u0000permissions\\";N;}s:8:\\"to_email\\";s:32:\\"jexterdeanbuenaventura@gmail.com\\";}s:7:\\"binding\\";N;s:5:\\"scope\\";s:42:\\"App\\\\Http\\\\Controllers\\\\DiscussionsController\\";s:8:\\"isStatic\\";b:0;}}"}}', 165, 0, NULL, 1477400493, 1477400493),
(9439, 'default', '{"job":"mailer@handleQueuedMessage","data":{"view":"emails.addParticipantEmail","data":{"from_email":"::entity::|App\\\\Models\\\\User|18","to_email":"jexterdeanbuenaventura@gmail.com"},"callback":"C:32:\\"SuperClosure\\\\SerializableClosure\\":3207:{a:5:{s:4:\\"code\\";s:182:\\"function ($message) use($from_email, $to_email) {\\n    $message->from($from_email->email, $from_email->name);\\n    $message->to($to_email);\\n    $message->subject($from_email->name);\\n};\\";s:7:\\"context\\";a:2:{s:10:\\"from_email\\";O:15:\\"App\\\\Models\\\\User\\":25:{s:11:\\"\\u0000*\\u0000fillable\\";a:18:{i:0;s:5:\\"email\\";i:1;s:8:\\"password\\";i:2;s:4:\\"name\\";i:3;s:5:\\"phone\\";i:4;s:5:\\"photo\\";i:5;s:6:\\"resume\\";i:6;s:9:\\"address_1\\";i:7;s:9:\\"address_2\\";i:8;s:7:\\"zipcode\\";i:9;s:10:\\"country_id\\";i:10;s:11:\\"user_status\\";i:11;s:5:\\"notes\\";i:12;s:5:\\"skype\\";i:13;s:8:\\"facebook\\";i:14;s:8:\\"linkedin\\";i:15;s:11:\\"timezone_id\\";i:16;s:14:\\"ticketit_admin\\";i:17;s:14:\\"ticketit_agent\\";}s:13:\\"\\u0000*\\u0000primaryKey\\";s:7:\\"user_id\\";s:8:\\"\\u0000*\\u0000table\\";s:4:\\"user\\";s:9:\\"\\u0000*\\u0000hidden\\";a:2:{i:0;s:8:\\"password\\";i:1;s:14:\\"remember_token\\";}s:13:\\"\\u0000*\\u0000connection\\";N;s:10:\\"\\u0000*\\u0000perPage\\";i:15;s:12:\\"incrementing\\";b:1;s:10:\\"timestamps\\";b:1;s:13:\\"\\u0000*\\u0000attributes\\";a:21:{s:7:\\"user_id\\";i:18;s:8:\\"password\\";s:60:\\"$2a$06$jtGr\\/GXKDi\\/DGzOHR6fRquvZqPKPTuHYDNOHk2wDSJlsBHjIAZjde\\";s:4:\\"name\\";s:24:\\"Jexter Dean Buenaventura\\";s:5:\\"email\\";s:26:\\"projectmanager@hdenergy.ca\\";s:5:\\"phone\\";s:10:\\"1234567890\\";s:5:\\"photo\\";s:35:\\"assets\\/user\\\\Snapshot_20160526_2.JPG\\";s:6:\\"resume\\";s:70:\\"assets\\/user\\/resumes\\\\Sample-Resume-Computer-Programmer-Entry-Level1.doc\\";s:9:\\"address_1\\";s:23:\\"#14 A Wakat Suello Road\\";s:9:\\"address_2\\";s:0:\\"\\";s:7:\\"zipcode\\";s:4:\\"2600\\";s:10:\\"country_id\\";s:3:\\"185\\";s:5:\\"skype\\";s:9:\\"arcblades\\";s:8:\\"facebook\\";s:10:\\"jexterdean\\";s:8:\\"linkedin\\";s:10:\\"jexterdean\\";s:11:\\"user_status\\";s:6:\\"Active\\";s:5:\\"notes\\";s:16:\\"<p>Testing<\\/p>\\r\\n\\";s:14:\\"remember_token\\";s:60:\\"ffCDBDfBnzgXghhFIuMyLqb417SFlPe8gpZkL14NdGzEk8hMdmSJwjWRHQkp\\";s:10:\\"created_at\\";s:19:\\"2016-10-24 22:40:26\\";s:10:\\"updated_at\\";s:19:\\"2016-10-24 14:40:26\\";s:14:\\"ticketit_admin\\";i:1;s:14:\\"ticketit_agent\\";i:0;}s:11:\\"\\u0000*\\u0000original\\";a:21:{s:7:\\"user_id\\";i:18;s:8:\\"password\\";s:60:\\"$2a$06$jtGr\\/GXKDi\\/DGzOHR6fRquvZqPKPTuHYDNOHk2wDSJlsBHjIAZjde\\";s:4:\\"name\\";s:24:\\"Jexter Dean Buenaventura\\";s:5:\\"email\\";s:26:\\"projectmanager@hdenergy.ca\\";s:5:\\"phone\\";s:10:\\"1234567890\\";s:5:\\"photo\\";s:35:\\"assets\\/user\\\\Snapshot_20160526_2.JPG\\";s:6:\\"resume\\";s:70:\\"assets\\/user\\/resumes\\\\Sample-Resume-Computer-Programmer-Entry-Level1.doc\\";s:9:\\"address_1\\";s:23:\\"#14 A Wakat Suello Road\\";s:9:\\"address_2\\";s:0:\\"\\";s:7:\\"zipcode\\";s:4:\\"2600\\";s:10:\\"country_id\\";s:3:\\"185\\";s:5:\\"skype\\";s:9:\\"arcblades\\";s:8:\\"facebook\\";s:10:\\"jexterdean\\";s:8:\\"linkedin\\";s:10:\\"jexterdean\\";s:11:\\"user_status\\";s:6:\\"Active\\";s:5:\\"notes\\";s:16:\\"<p>Testing<\\/p>\\r\\n\\";s:14:\\"remember_token\\";s:60:\\"ffCDBDfBnzgXghhFIuMyLqb417SFlPe8gpZkL14NdGzEk8hMdmSJwjWRHQkp\\";s:10:\\"created_at\\";s:19:\\"2016-10-24 22:40:26\\";s:10:\\"updated_at\\";s:19:\\"2016-10-24 14:40:26\\";s:14:\\"ticketit_admin\\";i:1;s:14:\\"ticketit_agent\\";i:0;}s:12:\\"\\u0000*\\u0000relations\\";a:0:{}s:10:\\"\\u0000*\\u0000visible\\";a:0:{}s:10:\\"\\u0000*\\u0000appends\\";a:0:{}s:10:\\"\\u0000*\\u0000guarded\\";a:1:{i:0;s:1:\\"*\\";}s:8:\\"\\u0000*\\u0000dates\\";a:0:{}s:13:\\"\\u0000*\\u0000dateFormat\\";N;s:8:\\"\\u0000*\\u0000casts\\";a:0:{}s:10:\\"\\u0000*\\u0000touches\\";a:0:{}s:14:\\"\\u0000*\\u0000observables\\";a:0:{}s:7:\\"\\u0000*\\u0000with\\";a:0:{}s:13:\\"\\u0000*\\u0000morphClass\\";N;s:6:\\"exists\\";b:1;s:18:\\"wasRecentlyCreated\\";b:0;s:8:\\"\\u0000*\\u0000roles\\";N;s:14:\\"\\u0000*\\u0000permissions\\";N;}s:8:\\"to_email\\";s:32:\\"jexterdeanbuenaventura@gmail.com\\";}s:7:\\"binding\\";N;s:5:\\"scope\\";s:42:\\"App\\\\Http\\\\Controllers\\\\DiscussionsController\\";s:8:\\"isStatic\\";b:0;}}"}}', 215, 0, NULL, 1477400494, 1477400494),
(9440, 'default', '{"job":"mailer@handleQueuedMessage","data":{"view":"user.forgotPassword","data":{"email":"jexterdeanbuenaventura@gmail.com","password":"76bda"},"callback":"C:32:\\"SuperClosure\\\\SerializableClosure\\":261:{a:5:{s:4:\\"code\\";s:122:\\"function ($message) {\\n    $message->to(\\\\Input::get(''email''), ''Forgot Password'')->subject(''Forgot Password Reset Link'');\\n};\\";s:7:\\"context\\";a:0:{}s:7:\\"binding\\";N;s:5:\\"scope\\";s:38:\\"App\\\\Http\\\\Controllers\\\\ProfileController\\";s:8:\\"isStatic\\";b:0;}}"}}', 255, 0, NULL, 1477400496, 1477400496),
(9441, 'default', '{"job":"mailer@handleQueuedMessage","data":{"view":"user.forgotPassword","data":{"email":"jexterdeanbuenaventura@gmail.com","password":"7a2c7"},"callback":"C:32:\\"SuperClosure\\\\SerializableClosure\\":261:{a:5:{s:4:\\"code\\";s:122:\\"function ($message) {\\n    $message->to(\\\\Input::get(''email''), ''Forgot Password'')->subject(''Forgot Password Reset Link'');\\n};\\";s:7:\\"context\\";a:0:{}s:7:\\"binding\\";N;s:5:\\"scope\\";s:38:\\"App\\\\Http\\\\Controllers\\\\ProfileController\\";s:8:\\"isStatic\\";b:0;}}"}}', 255, 0, NULL, 1477400498, 1477400498),
(9442, 'default', '{"job":"mailer@handleQueuedMessage","data":{"view":"user.forgotPassword","data":{"email":"jexterdeanbuenaventura@gmail.com","password":"4165f"},"callback":"C:32:\\"SuperClosure\\\\SerializableClosure\\":261:{a:5:{s:4:\\"code\\";s:122:\\"function ($message) {\\n    $message->to(\\\\Input::get(''email''), ''Forgot Password'')->subject(''Forgot Password Reset Link'');\\n};\\";s:7:\\"context\\";a:0:{}s:7:\\"binding\\";N;s:5:\\"scope\\";s:38:\\"App\\\\Http\\\\Controllers\\\\ProfileController\\";s:8:\\"isStatic\\";b:0;}}"}}', 255, 0, NULL, 1477400499, 1477400499);
...
('2016_07_22_063508_update_table_jobs_add_field_criteria', 49),
('2016_07_22_063516_update_table_applicants_add_field_criteria', 49),
('2016_07_29_083758_update_test_table_add_company_id', 49),
('2016_08_03_084140_update_test_result_add_local_record_id', 49),
('2016_08_11_032340_add_team_table_title_column', 49),
('2016_08_18_145611_update_password_resets_table_add_user_type', 50),
('2016_08_26_073130_alter_applicants_table', 51),
('2016_08_30_085944_update_tabel_question_update_question', 51),
('2016_08_30_095032_update_test_add_default_question_type', 51),
('2016_10_12_083014_create_video_sessions_table', 53),
('2016_09_07_122811_create_video_rooms_table', 54),
('2016_10_10_090357_add_soft_delete', 56),
('2016_10_13_091140_add_project_table_soft_delete', 56),
('2016_10_15_121954_create_discussions_table', 57),
('2016_10_26_101236_update_timer_table_add_total_time_change_project_id_to_task_id', 58),
('2016_10_29_083721_create_links_order_table', 59),
('2016_11_08_134851_update_timer_table_add_project_id_and_task_id', 60),
('2016_11_09_091753_create_rates_table', 61),
('2016_11_15_103951_create_task_checklist_status', 62),
('2016_11_25_073544_update_rates_table_add_pay_period', 63),
('2016_11_25_102435_create_payroll_table_columns', 64),
('2016_11_28_080845_create_payroll_pay_period_table', 65),
('2016_11_28_120606_update_rates_table_pay_period_to_pay_period_id', 66),
('2016_11_28_133204_create_user_pay_period_table', 67),
('2016_11_29_112449_update_payroll_columns_add_column_type', 68),
('2016_11_30_084149_create_user_payroll_columns', 69);
...
`id` int(10) unsigned NOT NULL,
  `usertype` enum('applicant','employee') COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `fp_password_resets`
--

INSERT INTO `fp_password_resets` (`email`, `token`, `id`, `usertype`, `created_at`, `updated_at`) VALUES
('jexterdeanbuenaventura@gmail.com', 'c8d19', 1, 'employee', '2016-08-19 02:34:20', '2016-08-19 02:34:20'),
('jexterdeanbuenaventura@gmail.com', 'facd7', 2, 'employee', '2016-08-19 02:36:24', '2016-08-19 02:36:24'),
('jexterdeanbuenaventura@gmail.com', '76bda', 3, 'employee', '2016-08-19 02:43:02', '2016-08-19 02:43:02'),
('jexterdeanbuenaventura@gmail.com', '7a2c7', 4, 'employee', '2016-08-19 02:50:13', '2016-08-19 02:50:13'),
('jexterdeanbuenaventura@gmail.com', '4165f', 5, 'employee', '2016-08-19 02:51:37', '2016-08-19 02:51:37'),
('jexterdeanbuenaventura@gmail.com', 'c7a33', 6, 'employee', '2016-08-19 02:56:11', '2016-08-19 02:56:11'),
('jexterdeanbuenaventura@gmail.com', '3adba', 7, 'employee', '2016-08-19 03:37:56', '2016-08-19 03:37:56');
...
--
-- Table structure for table `fp_payroll_columns`
--

CREATE TABLE IF NOT EXISTS `fp_payroll_columns` (
`id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `fp_payroll_columns`
--

INSERT INTO `fp_payroll_columns` (`id`, `column_name`, `column_type`, `default_value`, `created_at`, `updated_at`) VALUES
(10, 'Test', 'additions', '15', '2016-11-29 04:02:39', '2016-11-30 00:26:46'),
(11, 'Test 2', 'deductions', '10', '2016-11-29 04:23:50', '2016-11-29 04:23:50'),
(12, 'Test 3', 'additions', '4', '2016-11-29 04:27:11', '2016-11-30 00:31:33'),
(13, 'Test 4', 'additions', '3', '2016-11-29 04:36:43', '2016-11-29 04:36:43'),
(14, 'Test 5', 'deductions', '7', '2016-11-29 04:36:51', '2016-11-29 04:36:51'),
(16, 'Test 6', 'deductions', '12', '2016-11-30 00:40:07', '2016-11-30 00:40:07'),
(17, 'Test 7', 'additions', '12', '2016-11-30 01:18:14', '2016-11-30 01:18:14');

-- --------------------------------------------------------

--
-- Table structure for table `fp_payroll_pay_periods`
--

CREATE TABLE IF NOT EXISTS `fp_payroll_pay_periods` (
`id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `fp_payroll_pay_periods`
--

INSERT INTO `fp_payroll_pay_periods` (`id`, `period`, `default`, `created_at`, `updated_at`) VALUES
(1, 'biweekly', 'Friday', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 'weekly', 'Friday', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, 'monthly', '30', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 'semi-monthly', '30,30', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(210, 65, 1, 38, '2016-07-14 02:28:24', '2016-08-15 04:55:05'),
...
(72, 210, 'equal', 114, '2016-07-14 02:28:24', '2016-08-15 04:55:05'),
...
INSERT INTO `fp_project` (`project_id`, `company_id`, `user_id`, `ref_no`, `project_title`, `start_date`, `deadline`, `project_description`, `rate_type`, `rate_value`, `project_progress`, `created_at`, `updated_at`, `account`, `reverence`, `currency`, `project_type`, `deleted_at`) VALUES
(2, 1, 18, '2', 'Test Project Jex ', '2016-11-07 12:03:36', '0000-00-00 00:00:00', 'Test Project Jex', 'hourly', 50, 0, '2016-04-26 05:53:01', '2016-11-07 04:03:36', '12345', 'Test', 'PHP', '', NULL),
(5, 1, 18, '5', 'Test Project Jex 1', '2016-11-08 12:18:31', '0000-00-00 00:00:00', '', '', 100, 0, '2016-05-16 20:08:53', '2016-06-23 07:32:56', '', '', 'USD', '', NULL),
(6, 15, 18, '6', 'Test 1', '2016-06-01 09:47:58', '0000-00-00 00:00:00', 'Test 1', '', 0, 0, '2016-05-16 23:45:08', '2016-05-16 23:45:08', '', '', '', 'Software Development', NULL),
(8, 1, 18, '8', 'Test Project Jex 2', '2016-06-03 10:22:24', '2016-06-29 16:00:00', 'Test Project Jex 2', 'hourly', 12, 0, '2016-06-03 02:22:24', '2016-06-03 02:22:24', '1234', '', 'USD', '', NULL),
(12, 18, 18, '12', 'Test Jex Project 6', '2016-06-03 11:38:07', '0000-00-00 00:00:00', 'Test Jex Project 6', '', 0, 0, '2016-06-03 03:38:07', '2016-06-03 03:38:07', '', '', '', 'Coding', NULL),
(15, 1, 18, '15', 'Test Project Jex 3', '2016-06-23 14:02:59', '0000-00-00 00:00:00', 'Test', '', 0, 0, '2016-06-23 06:02:59', '2016-06-23 06:02:59', '', '', '', 'Hiring Assessment', NULL),
(19, 1, 18, '19', 'Test Project Jex 4', '2016-06-24 10:28:45', '0000-00-00 00:00:00', '', '', 0, 0, '2016-06-24 02:28:45', '2016-06-24 02:28:45', '', '', '', 'Standard', NULL),
(109, 1, 18, '109', 'Test 9', '2016-06-24 16:07:18', '0000-00-00 00:00:00', '', '', 0, 0, '2016-06-24 08:07:18', '2016-06-24 08:07:18', '', '', '', 'Standard', NULL),
(110, 1, 18, '110', 'Test 10', '2016-06-24 16:07:28', '0000-00-00 00:00:00', '', '', 0, 0, '2016-06-24 08:07:28', '2016-06-24 08:07:28', '', '', '', 'Standard', NULL),
(111, 1, 18, '111', 'Test 11', '2016-06-24 16:07:34', '0000-00-00 00:00:00', '', '', 0, 0, '2016-06-24 08:07:34', '2016-06-24 08:07:34', '', '', '', 'Standard', NULL),
(112, 1, 18, '112', 'Test 12', '2016-06-24 16:08:15', '0000-00-00 00:00:00', '', '', 0, 0, '2016-06-24 08:08:15', '2016-06-24 08:08:15', '', '', '', 'Standard', NULL),
(113, 1, 18, '113', 'Test 13', '2016-06-28 07:59:03', '0000-00-00 00:00:00', '', '', 0, 0, '2016-06-27 23:59:03', '2016-06-27 23:59:03', '', '', '', 'Standard', NULL),
(114, 1, 18, '114', 'Test 14', '2016-06-28 07:59:09', '0000-00-00 00:00:00', '', '', 0, 0, '2016-06-27 23:59:09', '2016-06-27 23:59:09', '', '', '', 'Standard', NULL),
(116, 1, 18, '116', 'Test 16', '2016-11-07 11:59:13', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-04 23:07:19', '2016-11-07 03:59:13', '', '', '', 'Standard', '2016-11-07 03:59:13'),
(117, 0, 96, '117', 'Testing', '2016-07-18 15:40:57', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-18 07:40:57', '2016-07-18 07:40:57', '', '', '', 'Standard', NULL),
(118, 0, 96, '118', 'Testing Again', '2016-07-18 15:47:32', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-18 07:47:31', '2016-07-18 07:47:32', '', '', '', 'Standard', NULL),
(119, 0, 97, '119', 'Test', '2016-07-19 07:19:38', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-18 23:19:38', '2016-07-18 23:19:38', '', '', '', 'Standard', NULL),
(120, 0, 97, '120', 'Test 2', '2016-07-19 07:28:41', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-18 23:28:41', '2016-07-18 23:28:41', '', '', '', 'Standard', NULL),
(121, 0, 18, '121', 'Test 17', '2016-07-21 09:24:08', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 01:24:07', '2016-07-21 01:24:08', '', '', '', 'Standard', NULL),
(122, 0, 18, '122', 'Test 18', '2016-07-21 09:41:58', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 01:41:58', '2016-07-21 01:41:58', '', '', '', 'Standard', NULL),
(123, 0, 18, '123', 'Test 19', '2016-07-21 09:42:28', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 01:42:28', '2016-07-21 01:42:28', '', '', '', 'Standard', NULL),
(124, 0, 18, '124', 'Test 20', '2016-07-21 09:52:50', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 01:52:50', '2016-07-21 01:52:50', '', '', '', 'Standard', NULL),
(125, 0, 18, '125', 'Test 21', '2016-07-21 09:54:10', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 01:54:10', '2016-07-21 01:54:10', '', '', '', 'Standard', NULL),
(126, 0, 18, '126', 'Test 22', '2016-07-21 09:56:32', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 01:56:32', '2016-07-21 01:56:32', '', '', '', 'Standard', NULL),
(127, 0, 18, '127', 'Test 23', '2016-07-21 09:57:06', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 01:57:06', '2016-07-21 01:57:06', '', '', '', 'Standard', NULL),
(128, 0, 18, '128', 'Test 24', '2016-07-21 09:59:16', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 01:59:16', '2016-07-21 01:59:16', '', '', '', 'Standard', NULL),
(129, 0, 18, '129', 'Test 25', '2016-07-21 10:51:20', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 02:51:20', '2016-07-21 02:51:20', '', '', '', 'Standard', NULL),
(130, 0, 18, '130', 'Test 26', '2016-07-21 12:03:51', '0000-00-00 00:00:00', '', '', 0, 0, '2016-07-21 04:03:51', '2016-07-21 04:03:51', '', '', '', 'Standard', NULL),
(131, 1, 18, '131', 'Test Project', '2016-11-07 11:58:32', '2016-12-09 16:00:00', 'Test', 'hourly', 50, 0, '2016-11-07 03:55:41', '2016-11-07 03:58:32', '1234567', '', 'PHP', 'Coding', '2016-11-07 03:58:32');
...
--
-- Table structure for table `fp_rates`
--

CREATE TABLE IF NOT EXISTS `fp_rates` (
`id` int(10) unsigned NOT NULL,
  `profile_id` int(11) NOT NULL,
  `rate_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'hourly',
  `rate_value` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `currency` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'PHP',
...
--
-- Dumping data for table `fp_rates`
--

INSERT INTO `fp_rates` (`id`, `profile_id`, `rate_type`, `rate_value`, `currency`, `pay_period_id`, `created_at`, `updated_at`) VALUES
(18, 114, 'hourly', '160', 'CAD', 1, '2016-11-29 00:29:49', '2016-11-29 00:41:55'),
(19, 119, 'hourly', '12', 'CAD', 1, '2016-11-29 00:38:11', '2016-11-29 00:38:11'),
(20, 118, 'hourly', '100', 'CAD', 1, '2016-11-29 01:56:05', '2016-11-29 01:56:05');
...
('16652e9192b2a7c039cfca62a5e9bc5c48648c90', '', 1480576709);
...
INSERT INTO `fp_task` (`task_id`, `belongs_to`, `unique_id`, `task_title`, `task_description`, `due_date`, `is_visible`, `task_status`, `created_at`, `updated_at`, `user_id`, `project_id`, `deleted_at`) VALUES
(19, 'project', 2, 'Test 2', 'Test 2', '2016-05-17 04:04:40', 'yes', 'pending', '2016-05-06 00:03:24', '2016-05-06 00:03:24', 34, 2, NULL),
(20, 'project', 4, 'Test Task', 'Test ', '2016-05-17 04:04:44', 'yes', 'pending', '2016-05-15 20:35:35', '2016-05-15 20:35:35', 38, 4, NULL),
(21, 'project', 3, 'Testing tasklist for Test 2', 'Test', '2016-05-17 04:04:47', 'yes', 'pending', '2016-05-16 04:50:36', '2016-05-16 04:50:36', 39, 3, NULL),
(22, 'project', 5, 'Test 1', 'Test', '2016-05-17 04:20:22', 'yes', 'pending', '2016-05-16 20:19:22', '2016-05-16 20:19:22', 18, 5, NULL),
(23, 'project', 5, 'Test 2', 'Test 2', '0000-00-00 00:00:00', 'yes', 'pending', '2016-05-16 20:20:34', '2016-05-16 20:20:34', 18, 5, NULL),
(24, 'project', 5, 'Test 3', 'Test 3', '0000-00-00 00:00:00', 'yes', 'pending', '2016-05-16 20:20:44', '2016-05-16 20:20:44', 18, 5, NULL),
(25, 'project', 5, '1', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-05-16 20:22:32', '2016-05-16 20:22:32', 18, 5, NULL),
(29, 'project', 6, 'Test', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-05-18 05:20:10', '2016-05-18 05:20:10', 18, 6, NULL),
(30, 'project', 6, 'Test 2', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-05-18 06:07:43', '2016-05-18 06:07:43', 18, 6, NULL),
(31, 'project', 6, 'Test 3', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-05-18 06:19:16', '2016-05-18 06:19:16', 18, 6, NULL),
(32, 'project', 6, 'Test 4', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-05-18 06:19:33', '2016-05-18 06:19:33', 18, 6, NULL),
(33, 'project', 7, 'Test', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-06-01 01:16:20', '2016-06-01 01:16:20', 42, 7, NULL),
(34, 'project', 6, 'Test 5', 'Test 5', '0000-00-00 00:00:00', 'yes', 'pending', '2016-06-03 00:29:04', '2016-06-03 00:29:04', 18, 6, NULL),
(36, 'project', 12, 'Test', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-06-03 03:43:24', '2016-06-03 03:43:24', 18, 12, NULL),
(38, 'project', 14, 'Jane Doe Test Subproject ', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-06-22 02:46:04', '2016-06-22 02:46:04', 19, 14, NULL),
(59, 'project', 2, 'Test 3', '', '2016-06-23 13:49:12', 'yes', 'pending', '2016-06-23 05:49:12', '2016-06-23 05:49:12', 18, 2, NULL),
(71, 'project', 15, 'Test 2', '', '2016-06-23 14:10:26', 'yes', 'pending', '2016-06-23 06:10:26', '2016-06-23 06:10:26', 18, 15, NULL),
(76, 'project', 8, 'Test', '', '2016-06-23 15:52:51', 'yes', 'pending', '2016-06-23 07:52:51', '2016-06-23 07:52:51', 18, 8, NULL),
(77, 'project', 8, 'Test 1', '', '2016-06-23 15:54:52', 'yes', 'pending', '2016-06-23 07:54:52', '2016-06-23 07:54:52', 18, 8, NULL),
(78, 'project', 8, 'Test 2', '', '2016-06-23 15:55:37', 'yes', 'pending', '2016-06-23 07:55:37', '2016-06-23 07:55:37', 18, 8, NULL),
(79, 'project', 15, 'Test 3', '', '2016-06-23 15:55:42', 'yes', 'pending', '2016-06-23 07:55:42', '2016-06-23 07:55:42', 18, 15, NULL),
(80, 'project', 5, 'Test 4', '', '2016-06-23 15:55:49', 'yes', 'pending', '2016-06-23 07:55:49', '2016-06-23 07:55:49', 18, 5, NULL),
(81, 'project', 14, 'This was added by Jex', '', '2016-06-23 16:01:09', 'yes', 'pending', '2016-06-23 08:01:09', '2016-06-23 08:01:09', 18, 14, NULL),
(82, 'project', 14, 'This was added by Jex', '', '2016-06-23 16:01:09', 'yes', 'pending', '2016-06-23 08:01:09', '2016-06-23 08:01:09', 18, 14, NULL),
(83, 'project', 14, 'This was added by Jex again', '', '2016-06-23 16:03:31', 'yes', 'pending', '2016-06-23 08:03:31', '2016-06-23 08:03:31', 18, 14, NULL),
(84, 'project', 15, 'Test 4', '', '2016-06-24 08:31:51', 'yes', 'pending', '2016-06-24 00:31:51', '2016-06-24 00:31:51', 18, 15, NULL),
(86, 'project', 2, 'Test 4', '', '2016-06-24 15:28:28', 'yes', 'pending', '2016-06-24 07:28:28', '2016-06-24 07:28:28', 18, 2, NULL),
(113, 'project', 2, 'Test 5', '', '2016-06-27 07:57:09', 'yes', 'pending', '2016-06-26 23:57:09', '2016-06-26 23:57:09', 18, 2, NULL),
(115, 'project', 2, 'Test 6', '', '2016-06-27 13:00:42', 'yes', 'pending', '2016-06-27 05:00:42', '2016-06-27 05:00:42', 18, 2, NULL),
(117, 'project', 111, 'Test', '', '2016-06-27 16:22:29', 'yes', 'pending', '2016-06-27 08:22:29', '2016-06-27 08:22:29', 18, 111, NULL),
(118, 'project', 111, 'Test 1', '', '2016-06-27 16:22:33', 'yes', 'pending', '2016-06-27 08:22:33', '2016-06-27 08:22:33', 18, 111, NULL),
(119, 'project', 2, 'Test 7', '', '2016-06-28 08:03:11', 'yes', 'pending', '2016-06-28 00:03:11', '2016-06-28 00:03:11', 18, 2, NULL),
(120, 'project', 14, 'Added by Jex', '', '2016-06-28 08:18:25', 'yes', 'pending', '2016-06-28 00:18:25', '2016-06-28 00:18:25', 18, 14, NULL),
(121, 'project', 2, 'Test 8', '', '2016-06-28 09:33:32', 'yes', 'pending', '2016-06-28 01:33:32', '2016-06-28 01:33:32', 18, 2, NULL),
(124, 'project', 2, 'Test 10', '', '2016-06-29 09:59:24', 'yes', 'pending', '2016-06-29 01:59:24', '2016-06-29 01:59:24', 18, 2, NULL),
(125, 'project', 2, 'Test 11', '', '2016-06-29 09:59:42', 'yes', 'pending', '2016-06-29 01:59:42', '2016-06-29 01:59:42', 18, 2, NULL),
(126, 'project', 2, 'Test 12', '', '2016-06-29 09:59:59', 'yes', 'pending', '2016-06-29 01:59:59', '2016-06-29 01:59:59', 18, 2, NULL),
(127, 'project', 12, 'Test 1', '', '2016-06-30 15:56:46', 'yes', 'pending', '2016-06-30 07:56:46', '2016-06-30 07:56:46', 18, 12, NULL),
(128, 'project', 12, 'Test 2', '', '2016-06-30 16:42:37', 'yes', 'pending', '2016-06-30 08:42:37', '2016-06-30 08:42:37', 18, 12, NULL),
(129, 'project', 12, 'Test 3', '', '2016-06-30 16:42:42', 'yes', 'pending', '2016-06-30 08:42:42', '2016-06-30 08:42:42', 18, 12, NULL),
(130, 'project', 12, 'Test 4', '', '2016-06-30 16:44:41', 'yes', 'pending', '2016-06-30 08:44:41', '2016-06-30 08:44:41', 18, 12, NULL),
(131, 'project', 12, 'Test 5', '', '2016-06-30 16:45:03', 'yes', 'pending', '2016-06-30 08:45:03', '2016-06-30 08:45:03', 18, 12, NULL),
(133, 'project', 2, 'Test 9', '', '2016-07-07 07:13:53', 'yes', 'pending', '2016-07-06 23:13:53', '2016-07-06 23:13:53', 18, 2, NULL),
(134, 'project', 14, 'This was added by Jex again', '', '2016-07-07 07:17:28', 'yes', 'pending', '2016-07-06 23:17:28', '2016-07-06 23:17:28', 18, 14, NULL),
(138, 'project', 112, 'Test', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-07-13 05:01:01', '2016-07-13 05:01:01', 18, 112, NULL),
(139, 'project', 112, 'Test 1', 'Test 1', '0000-00-00 00:00:00', 'yes', 'pending', '2016-07-13 05:01:16', '2016-07-13 05:01:16', 18, 112, NULL),
(140, 'project', 2, 'Test 10', '', '0000-00-00 00:00:00', 'yes', 'pending', '2016-07-18 06:12:50', '2016-07-18 06:12:50', 18, 2, NULL),
(141, 'project', 2, 'Test 13', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-07-18 06:31:59', '2016-07-18 06:31:59', 18, 2, NULL),
(142, 'project', 2, 'Test 14', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-07-18 06:34:37', '2016-07-18 06:34:37', 18, 2, NULL),
(143, 'project', 2, 'Test 15', 'Test', '0000-00-00 00:00:00', 'yes', 'pending', '2016-07-18 06:48:51', '2016-07-18 06:48:51', 18, 2, NULL),
(144, 'project', 119, 'Test', '', '2016-07-19 07:37:17', 'yes', 'pending', '2016-07-18 23:37:17', '2016-07-18 23:37:17', 97, 119, NULL),
(145, 'project', 119, 'Test 1', '', '2016-07-19 07:56:26', 'yes', 'pending', '2016-07-18 23:56:26', '2016-07-18 23:56:26', 97, 119, NULL),
(146, 'project', 119, 'Test 2', '', '2016-07-19 07:58:02', 'yes', 'pending', '2016-07-18 23:58:02', '2016-07-18 23:58:02', 97, 119, NULL),
(147, 'project', 119, 'Test 3', '', '2016-07-19 08:06:00', 'yes', 'pending', '2016-07-19 00:06:00', '2016-07-19 00:06:00', 97, 119, NULL),
(148, 'project', 116, 'Test', 'Test', '2016-11-07 11:59:10', 'yes', 'pending', '2016-07-24 23:57:35', '2016-11-07 03:59:10', 18, 116, '2016-11-07 03:59:10'),
(149, 'project', 116, 'Testing', 'Test', '2016-11-07 11:59:10', 'yes', 'pending', '2016-07-24 23:57:53', '2016-11-07 03:59:10', 18, 116, '2016-11-07 03:59:10'),
(150, 'project', 2, 'Test 10', '', '0000-00-00 00:00:00', 'yes', 'pending', '2016-08-12 23:28:55', '2016-08-12 23:28:55', 18, 2, NULL),
(151, 'project', 131, 'TestBriefcase', 'Test', '2016-11-07 11:58:31', 'yes', 'pending', '2016-11-07 03:56:32', '2016-11-07 03:58:31', 18, 131, '2016-11-07 03:58:31');
...
(224, 34, 19, 'Test 12', 'Test', '2016-05-04 05:29:47', '2016-11-15 00:13:53', 'Default'),
(225, 0, 18, 'Test 8', 'Test 9', '2016-05-05 00:51:05', '2016-05-08 22:16:50', 'Ongoing'),
(226, 34, 19, 'Test 9', 'Test 9', '2016-05-05 01:04:07', '2016-11-15 00:13:48', 'Default'),
...
(244, 34, 19, 'Test 13', '<p>Test 13</p>\n', '2016-05-05 06:35:36', '2016-11-15 01:52:20', 'Ongoing'),
...
(445, 34, 19, 'Testing 9', '<p>Testing 9</p>\n', '2016-06-10 01:51:59', '2016-11-15 01:05:07', 'Ongoing'),
(512, 18, 24, 'Test 1', '<iframe style="height: 800px;" id="spreadsheet_iframe" class="spreadsheet_iframe" src="https://job.tc:9000/task-spreadsheet-FASLy"></iframe>', '2016-06-10 07:16:33', '2016-11-08 02:06:22', 'Ongoing'),
(520, 18, 24, 'Test 2', '<p><img height="181" src="http://localhost:8000/assets/ckeditor_uploaded_images/company_logo_2.jpg" width="278" /></p>\r\n', '2016-06-10 07:29:50', '2016-11-08 02:06:24', 'Ongoing'),
(521, 18, 24, 'Test 3', '<p>Test 3<img height="110" src="http://localhost:8000/assets/ckeditor_uploaded_images/company_logo_3.png" width="459" /></p>\n', '2016-06-10 07:30:50', '2016-11-08 02:06:26', 'Ongoing'),
...
(558, 18, 86, 'Testing', '<p>Test</p>\r\n', '2016-06-26 23:25:49', '2016-11-14 06:27:11', 'Default'),
(559, 18, 119, 'Test', '<p>Test</p>\n', '2016-06-28 00:03:14', '2016-11-14 06:26:59', 'Default'),
...
(581, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-07-18 05:27:44', '2016-11-14 08:06:52', 'Ongoing'),
(582, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-07-18 05:28:41', '2016-11-14 08:06:58', 'Ongoing'),
...
(602, 18, 133, 'This is another task item', '<p>Test</p>\r\n', '2016-07-25 01:13:59', '2016-11-14 08:08:35', 'Ongoing'),
(603, 18, 124, 'Test', '<p>Test</p>\r\n', '2016-07-27 04:51:12', '2016-08-13 04:41:41', 'Default'),
(604, 18, 124, 'Test', '<p>Test</p>\r\n', '2016-08-15 04:41:41', '2016-08-15 04:41:47', 'Default'),
(605, 18, 124, 'Testing', '<p>Test Test</p>\r\n', '2016-08-15 04:44:12', '2016-10-24 00:26:47', 'Default'),
(606, 18, 121, 'Testing', '<p>Test</p>\r\n', '2016-11-03 00:44:56', '2016-11-14 06:26:51', 'Default'),
(607, 18, 133, 'Testing', '<p>Testing</p>\r\n', '2016-11-03 23:46:46', '2016-11-14 07:40:44', 'Ongoing'),
(608, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-11-04 02:02:29', '2016-11-14 07:37:24', 'Ongoing'),
(609, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-11-04 02:20:56', '2016-11-14 07:35:54', 'Ongoing'),
(610, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-11-04 02:33:53', '2016-11-14 07:35:16', 'Ongoing'),
(623, 18, 133, 'TestingTest', '<p>Te</p>\r\n', '2016-11-04 03:45:09', '2016-11-14 07:31:19', 'Ongoing'),
(624, 18, 133, 'Test', '<p>Testing</p>\r\n', '2016-11-04 03:45:37', '2016-11-14 07:24:59', 'Ongoing'),
(630, 18, 133, 'Testing', '<p>Tesitng</p>\r\n', '2016-11-04 04:07:52', '2016-11-14 07:21:54', 'Ongoing'),
(631, 18, 133, 'TestingTest', '<p>TestingTest</p>\r\n', '2016-11-04 04:08:50', '2016-11-14 07:11:00', 'Ongoing'),
(633, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-11-04 04:24:33', '2016-11-14 07:08:24', 'Ongoing'),
(634, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-11-04 04:35:24', '2016-11-14 07:06:05', 'Ongoing'),
(635, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-11-04 04:39:51', '2016-11-14 07:03:08', 'Ongoing'),
(636, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-11-04 04:40:22', '2016-11-14 07:01:06', 'Ongoing'),
(637, 18, 133, 'Testing', '<p>Test</p>\r\n', '2016-11-04 04:41:52', '2016-11-14 08:03:29', 'Ongoing'),
(638, 18, 133, 'Testing 2', '<p>Test</p>\r\n', '2016-11-04 05:13:15', '2016-11-14 06:57:09', 'Ongoing'),
(639, 18, 133, 'Testing 2', '<p>Test</p>\r\n', '2016-11-04 05:13:30', '2016-11-14 06:50:53', 'Ongoing'),
(640, 18, 133, 'Testing 3', '<p>Test</p>\r\n', '2016-11-07 03:43:05', '2016-11-14 06:56:39', 'Ongoing'),
(641, 18, 78, 'Task for Jane Doe', '<p>Test</p>\r\n', '2016-11-10 03:33:36', '2016-11-10 03:34:21', 'Ongoing'),
(642, 18, 133, 'Testing 4', '<p>Testin</p>\r\n', '2016-11-14 08:09:47', '2016-11-14 08:22:10', 'Ongoing'),
(643, 18, 133, 'Testing 5', '<p>Testing 5</p>\r\n', '2016-11-14 08:13:16', '2016-11-14 08:18:56', 'Ongoing'),
(644, 18, 133, 'Testing 6', '<p>Testing 6</p>\r\n', '2016-11-14 08:16:51', '2016-11-15 00:03:05', 'Ongoing'),
(645, 18, 133, 'Testing 7', '<p>Testing 7</p>\r\n', '2016-11-14 08:18:19', '2016-11-15 00:05:43', 'Ongoing'),
(646, 18, 139, 'Testing', '<p>Test</p>\r\n', '2016-11-17 04:00:19', '2016-11-17 04:00:25', 'Default');
...
(466, 133, '602,581,582,607,607,608,608,609,609,610,610,623,623,624,623,627,628,630,630,631,631,632,633,633,634,634,635,635,636,636,637,637,638,638,639,638,640,640,640,642,642,643,643,644,644,645,645,646', '2016-11-03 01:33:55', '2016-11-16 07:03:09'),
(469, 19, '263,445,261,193,244,224,259,226', '2016-11-15 01:57:15', '2016-11-15 01:57:15');
...
(135, 76, 98, 8, 1, '2016-11-10 03:27:37', '2016-11-10 03:27:37'),
(136, 77, 98, 8, 1, '2016-11-10 03:27:37', '2016-11-10 03:27:37'),
(137, 78, 98, 8, 1, '2016-11-10 03:27:37', '2016-11-10 03:27:37'),
(138, 76, 62, 8, 1, '2016-11-17 03:59:05', '2016-11-17 03:59:05'),
(139, 77, 62, 8, 1, '2016-11-17 03:59:06', '2016-11-17 03:59:06'),
(140, 78, 62, 8, 1, '2016-11-17 03:59:06', '2016-11-17 03:59:06'),
(141, 138, 62, 112, 1, '2016-11-17 03:59:28', '2016-11-17 03:59:28'),
(142, 139, 62, 112, 1, '2016-11-17 03:59:28', '2016-11-17 03:59:28');

-- --------------------------------------------------------

--
-- Table structure for table `fp_task_check_list_status`
--

CREATE TABLE IF NOT EXISTS `fp_task_check_list_status` (
`id` int(10) unsigned NOT NULL,
  `task_checklist_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `fp_task_check_list_status`
--

INSERT INTO `fp_task_check_list_status` (`id`, `task_checklist_id`, `user_id`, `status`, `created_at`, `updated_at`) VALUES
(8, 602, 62, 'Ongoing', '2016-11-15 07:15:22', '2016-11-21 01:22:53'),
(9, 581, 62, 'Ongoing', '2016-11-15 08:03:05', '2016-11-21 01:44:22'),
(10, 602, 18, 'Ongoing', '0000-00-00 00:00:00', '2016-11-16 06:51:13'),
(11, 581, 18, 'Ongoing', '2016-11-15 08:14:41', '2016-11-16 06:53:47'),
(12, 582, 18, 'Ongoing', '2016-11-15 08:17:16', '2016-11-16 06:53:56'),
(13, 607, 18, 'Ongoing', '2016-11-16 06:28:49', '2016-11-16 06:54:01'),
(14, 608, 18, 'Ongoing', '2016-11-16 06:41:54', '2016-11-16 06:54:07'),
(15, 609, 18, 'Ongoing', '2016-11-16 06:43:44', '2016-11-16 06:54:11'),
(16, 610, 18, 'Ongoing', '2016-11-16 06:57:29', '2016-11-16 06:57:29'),
(17, 623, 18, 'Ongoing', '2016-11-16 06:57:41', '2016-11-16 06:57:41'),
(18, 624, 18, 'Ongoing', '2016-11-16 06:58:23', '2016-11-16 06:58:23'),
(19, 630, 18, 'Ongoing', '2016-11-16 06:59:58', '2016-11-16 06:59:58'),
(20, 631, 18, 'Ongoing', '2016-11-16 07:03:02', '2016-11-16 07:03:02'),
(21, 646, 62, 'Ongoing', '2016-11-17 04:00:28', '2016-11-17 04:00:28'),
(22, 641, 62, 'Ongoing', '2016-11-17 04:17:29', '2016-11-22 22:02:47'),
(23, 582, 62, 'Ongoing', '2016-11-18 02:49:07', '2016-11-21 02:06:36'),
(24, 607, 62, 'Ongoing', '2016-11-20 21:33:10', '2016-11-21 02:08:01'),
(25, 608, 62, 'Ongoing', '2016-11-21 02:54:13', '2016-11-21 02:54:32'),
(26, 606, 62, 'Ongoing', '2016-11-21 03:19:23', '2016-11-21 03:19:23'),
(27, 609, 62, 'Ongoing', '2016-11-22 04:10:29', '2016-11-22 04:10:29'),
(28, 559, 62, 'Ongoing', '2016-11-22 21:52:13', '2016-11-22 21:52:13'),
(29, 610, 62, 'Ongoing', '2016-11-24 02:21:07', '2016-11-24 02:21:07'),
(30, 623, 62, 'Ongoing', '2016-11-24 02:26:30', '2016-11-24 02:26:30'),
(31, 624, 62, 'Ongoing', '2016-11-24 02:32:21', '2016-11-24 02:32:21'),
(32, 630, 62, 'Ongoing', '2016-11-24 03:06:11', '2016-11-24 03:06:11');
...
INSERT INTO `fp_team` (`id`, `project_id`, `title`, `created_at`, `updated_at`) VALUES
...
(59, 17, 98, 1, '2016-11-10 03:26:45', '2016-11-10 03:26:45'),
(60, 17, 62, 1, '2016-11-17 03:58:49', '2016-11-17 03:58:49');
...
`id` int(10) unsigned NOT NULL,
  ...
  `default_question_type_id` int(11) NOT NULL
...
INSERT INTO `fp_test` (`id`, `user_id`, `company_id`, `title`, `description`, `length`, `version`, `average_score`, `test_photo`, `start_message`, `completion_message`, `created_at`, `updated_at`, `order`, `default_time`, `completion_image`, `completion_sound`, `default_tags`, `default_points`, `default_question_type_id`) VALUES
(1, 18, NULL, 'Test', 'Test', '00:00:00', 0.00, 0.00, '', 'Test', 'Test', '2016-04-27 02:30:33', '2016-05-17 05:13:41', 0.00, '00:00:00', '', '', '', 1.00, 0),
(2, 18, NULL, 'Test 2', 'Test 2', '00:00:00', 0.00, 0.00, '', 'Test 2', 'Test 2', '2016-04-27 02:32:35', '2016-04-27 02:32:35', 0.00, '00:00:00', '', '', '', 1.00, 0),
(3, 18, NULL, 'Test 3', 'Test 3', '00:00:00', 0.00, 0.00, '', 'Test 3', 'Test 3', '2016-04-27 02:41:32', '2016-04-27 02:41:32', 0.00, '00:00:00', '', '', '', 1.00, 0),
(4, 18, NULL, 'Test 4', 'Test 4', '00:00:00', 0.00, 0.00, '4.png', 'Test 4', 'Test 4', '2016-04-27 02:58:27', '2016-04-27 02:58:27', 0.00, '00:00:00', '', '', '', 1.00, 0),
(5, 18, NULL, 'Test 5', 'Test 5', '00:00:00', 0.00, 0.00, '5.jpg', 'Test 5', 'Test 5', '2016-04-27 03:06:05', '2016-04-27 03:06:05', 0.00, '00:00:00', '', '', '', 1.00, 0),
(6, 18, NULL, 'Test 6', 'Testing the Quiz', '00:00:00', 0.00, 0.00, '', 'Test Intro', 'Congratulations!', '2016-05-25 06:37:33', '2016-05-25 06:37:33', 0.00, '00:00:00', '', '', '', 1.00, 0),
(7, 18, NULL, 'Test', 'Test', '00:00:00', 0.00, 0.00, '', 'Test', 'Test', '2016-06-24 04:16:03', '2016-06-24 04:16:03', 0.00, '00:10:00', '4222.gif', 'applause.mp3', '', 1.00, 0),
(8, 18, NULL, 'Test', 'Test', '00:00:00', 0.00, 0.00, '', 'Test', 'Test', '2016-06-24 04:16:29', '2016-06-24 04:16:29', 0.00, '00:10:00', '', '', '', 1.00, 0),
(9, 18, NULL, 'Test 2', 'Test', '00:00:00', 0.00, 0.00, '', 'Test', 'Test', '2016-06-28 01:45:27', '2016-06-28 01:45:27', 0.00, '00:00:00', '', '', '', 1.00, 0),
(10, 18, NULL, 'Exam', 'Exam', '00:00:00', 0.00, 0.00, '', 'Test', 'Test', '2016-07-20 06:26:53', '2016-07-20 06:26:53', 0.00, '00:10:00', '', '', 'test', 1.00, 0);
...
`id` int(10) unsigned NOT NULL,
  ...
  `local_record_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `fp_test_result` (`id`, `test_id`, `question_id`, `unique_id`, `belongs_to`, `answer`, `local_record_id`, `record_id`, `result`, `created_at`, `updated_at`, `points`) VALUES
...
INSERT INTO `fp_timer` (`timer_id`, `user_id`, `project_id`, `task_id`, `task_checklist_id`, `start_time`, `end_time`, `total_time`, `timer_status`, `created_at`, `updated_at`) VALUES
(257, 62, 2, 133, 602, '2016-11-21 01:22:53', '2016-11-21 01:23:33', '00:00:40', 'Paused', '2016-11-18 01:22:53', '2016-11-21 01:23:33'),
(258, 62, 2, 133, 602, '2016-11-21 01:24:05', '2016-11-21 01:57:32', '00:01:41', 'Paused', '2016-10-01 01:24:05', '2016-11-21 01:57:32'),
(259, 62, 2, 133, 581, '2016-11-21 01:44:22', '2016-11-21 04:05:54', '00:04:24', 'Paused', '2016-11-21 01:44:22', '2016-11-21 04:05:54'),
(260, 62, 2, 133, 582, '2016-11-21 02:06:37', '2016-11-21 04:05:52', '00:04:54', 'Paused', '2016-11-21 02:06:37', '2016-11-21 04:05:52'),
(261, 62, 2, 133, 607, '2016-11-21 02:08:02', '2016-11-21 04:05:50', '00:06:03', 'Paused', '2016-11-21 02:08:02', '2016-11-21 04:05:50'),
(262, 62, 2, 133, 608, '2016-11-21 02:54:32', '2016-11-21 04:05:49', '00:25:02', 'Paused', '2016-11-21 02:54:32', '2016-11-21 04:05:49'),
(263, 62, 2, 121, 606, '2016-11-21 03:19:23', '2016-11-22 21:51:29', '00:00:08', 'Paused', '2016-11-21 03:19:23', '2016-11-22 21:51:29'),
(264, 62, 2, 133, 602, '2016-11-21 04:05:54', '2016-11-21 04:25:11', '00:19:04', 'Paused', '2016-11-21 04:05:54', '2016-11-21 04:25:11'),
(265, 62, 2, 133, 608, '2016-11-21 21:58:09', '2016-11-22 04:10:57', '00:00:23', 'Paused', '2016-11-21 21:58:09', '2016-11-22 04:10:57'),
(266, 62, 2, 133, 582, '2016-11-22 03:34:17', '2016-11-22 03:36:58', '00:02:41', 'Paused', '2016-11-22 03:34:17', '2016-11-22 03:36:58'),
(267, 62, 2, 133, 607, '2016-11-22 03:36:58', '2016-11-22 03:51:09', '00:14:07', 'Paused', '2016-11-22 03:36:58', '2016-11-22 03:51:09'),
(268, 62, 2, 133, 609, '2016-11-22 04:10:28', '2016-11-22 05:22:09', '00:23:09', 'Paused', '2016-11-22 04:10:28', '2016-11-22 05:22:09'),
(269, 62, 2, 121, 606, '2016-11-22 21:51:29', '2016-11-22 21:51:52', '00:00:30', 'Paused', '2016-11-22 21:51:29', '2016-11-22 21:51:52'),
(270, 62, 2, 119, 559, '2016-11-22 21:52:13', '2016-11-22 21:54:52', '00:02:29', 'Paused', '2016-11-22 21:52:13', '2016-11-22 21:54:52'),
(271, 62, 8, 78, 641, '2016-11-22 22:02:48', '2016-11-23 05:15:49', '05:06:15', 'Paused', '2016-11-22 22:02:48', '2016-11-23 05:15:49'),
(272, 62, 2, 133, 609, '2016-11-24 02:04:49', '2016-11-24 02:08:44', '00:02:11', 'Paused', '2016-11-24 02:04:49', '2016-11-24 02:08:44'),
(273, 62, 2, 133, 610, '2016-11-24 02:21:07', '2016-11-24 02:22:09', '00:00:44', 'Paused', '2016-11-24 02:21:07', '2016-11-24 02:22:09'),
(274, 62, 2, 133, 623, '2016-11-24 02:26:31', '2016-11-24 03:07:11', '00:00:13', 'Resumed', '2016-11-24 02:26:31', '2016-11-24 03:07:11'),
(275, 62, 2, 133, 624, '2016-11-24 02:32:21', '2016-11-24 02:33:55', '00:01:34', 'Paused', '2016-11-24 02:32:21', '2016-11-24 02:33:55'),
(276, 62, 2, 133, 630, '2016-11-24 03:06:11', '2016-11-24 03:07:00', '00:00:48', 'Paused', '2016-11-24 03:06:11', '2016-11-24 03:07:00');
...
(62, '$2a$08$cu9AZ5yfHWIWNFq.JA4eVONXfYU3zO.G7F.CqNPt4ioW/jBPikQ4C', 'Tryste Gothel', 'jexterdeanbuenaventura@gmail.com', '1234567890', 'assets/user/default-avatar.jpg', NULL, '', '', '', '185', '', '', '', 'Active', NULL, 'y78AaMjjSYNqEjSGsFi1yxqalgUNc60krppFBfGB6ZehUMtqBAdUS3ovUI4v', '2016-11-24 11:30:29', '2016-11-24 03:30:29', 0, 0),
...
(65, '$2y$10$CGITbECHGmNmGeXUu4i1d.d5sUUVpNAinH8PhfmbIPLA0tQlfhFki', 'Test User', 'testuser@gmail.com', '', 'assets/user/testjobseeker.jpg', 'assets/user/resumes\\Jhon Rey Resume.doc', '', '', '', '16', '', '', '', 'Active', NULL, '23Rex1LvyBg7JRpBIchDf6ww6UmB6IQkvEXunjRHfQJrveDjvztY66sQx8jD', '2016-08-15 12:55:04', '2016-08-15 04:55:04', 0, 0),
...
--
-- Table structure for table `fp_user_payroll_columns`
--

CREATE TABLE IF NOT EXISTS `fp_user_payroll_columns` (
`id` int(10) unsigned NOT NULL,
  `profile_id` int(11) NOT NULL,
  `payroll_column_id` int(11) NOT NULL,
...
--
-- Table structure for table `fp_user_pay_periods`
--

CREATE TABLE IF NOT EXISTS `fp_user_pay_periods` (
`id` int(10) unsigned NOT NULL,
  `pay_period_id` int(11) NOT NULL,
  `profile_id` int(11) NOT NULL,
  `payday` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `fp_user_pay_periods`
--

INSERT INTO `fp_user_pay_periods` (`id`, `pay_period_id`, `profile_id`, `payday`, `created_at`, `updated_at`) VALUES
(11, 1, 114, 'Monday,Monday', '2016-11-29 00:29:49', '2016-11-29 00:41:55'),
(12, 1, 119, 'Monday,Monday', '2016-11-29 00:38:11', '2016-11-29 00:38:11'),
(13, 1, 118, 'Monday,Monday', '2016-11-29 01:56:05', '2016-11-29 01:56:05');
...
--
-- Table structure for table `fp_video_rooms`
--

CREATE TABLE IF NOT EXISTS `fp_video_rooms` (
`id` int(10) unsigned NOT NULL,
  `session_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `nfo_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `room_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `room_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `stream` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `rec_dir` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `stream_start` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `stream_end` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `fp_video_rooms`
--

INSERT INTO `fp_video_rooms` (`id`, `session_id`, `nfo_id`, `room_name`, `room_type`, `stream`, `rec_dir`, `stream_start`, `stream_end`, `created_at`, `updated_at`) VALUES
(5, '447271909185980', '5164099899773463', '4', 'applicant', '2501427136506137', 'https://ubuntu-server.com/recordings', '', '', '2016-10-15 01:58:57', '2016-10-15 02:00:27'),
(7, '474909714755606', '5224176296613003', '4', 'applicant', '7946137791098159', 'https://ubuntu-server.com/recordings', '', '', '2016-10-15 02:39:03', '2016-10-15 02:40:02'),
(8, '187150373670162', '6180066292118164', '4', 'applicant', '7223779048610084', 'https://laravel.software/recordings', '', '', '2016-10-18 00:23:16', '2016-10-18 00:23:31'),
(9, '000287308882616', '1125725461135776', '4', 'applicant', '7250210572325430', 'https://laravel.software/recordings', '', '', '2016-10-18 00:25:03', '2016-10-18 00:25:12');

-- --------------------------------------------------------

--
-- Table structure for table `fp_video_sessions`
--

CREATE TABLE IF NOT EXISTS `fp_video_sessions` (
`id` int(10) unsigned NOT NULL,
  `session_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `unique_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `owner_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `total_time` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `is_recording` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `fp_video_sessions`
--

INSERT INTO `fp_video_sessions` (`id`, `session_id`, `unique_id`, `owner_type`, `total_time`, `is_recording`, `created_at`, `updated_at`) VALUES
(14, 'yKw2xzB0brvI', '4', 'applicant', '', 'No', '2016-10-13 05:11:12', '2016-10-13 05:11:54'),
(15, 'yKw2xzB0brvI', '4', 'applicant', '', 'No', '2016-10-13 05:11:12', '2016-10-13 05:11:54'),
(16, '15CRvgjFwue5', '4', 'applicant', '', 'No', '2016-10-14 00:44:18', '2016-10-14 00:44:40'),
(17, '1mhdtTAQGeg0', '4', 'applicant', '', 'No', '2016-10-14 00:45:18', '2016-10-14 00:45:30'),
(18, 'SfpJiXisFH6S', '4', 'applicant', '', 'No', '2016-10-14 01:04:45', '2016-10-14 01:06:03'),
(19, 'SfpJiXisFH6S', '4', 'applicant', '', 'No', '2016-10-14 01:04:45', '2016-10-14 01:06:03'),
(20, 'GsiYbE8jhLmO', '4', 'applicant', '', 'Yes', '2016-10-14 01:10:59', '2016-10-14 01:10:59'),
(21, 'GsiYbE8jhLmO', '4', 'applicant', '', 'Yes', '2016-10-14 01:10:59', '2016-10-14 01:10:59'),
(22, 'Yes', '4', 'applicant', '', 'Yes', '2016-10-14 01:45:13', '2016-10-14 01:45:13'),
(23, 'Yes', '4', 'applicant', '', 'Yes', '2016-10-14 01:47:16', '2016-10-14 01:47:16'),
(24, 'VGEoyvwMDuv9', '4', 'applicant', '', 'No', '2016-10-14 01:47:21', '2016-10-14 01:47:30'),
(25, 'Yes', '4', 'applicant', '', 'Yes', '2016-10-14 01:47:59', '2016-10-14 01:47:59'),
(26, 'Yr69fWuVeflN', '4', 'applicant', '', 'No', '2016-10-14 01:48:02', '2016-10-14 01:50:08'),
(27, 'Yes', '4', 'applicant', '', 'Yes', '2016-10-14 01:52:17', '2016-10-14 01:52:17'),
(28, 'jzj6AiwCB6rS', '4', 'applicant', '', 'Yes', '2016-10-14 01:53:47', '2016-10-14 01:53:47'),
(29, 'B9xXK56eApGN', '4', 'applicant', '', 'No', '2016-10-14 01:58:23', '2016-10-14 02:00:24'),
(30, '354481689274', '4', 'applicant', '', 'No', '2016-10-14 02:11:07', '2016-10-14 02:11:38'),
(31, '331667451449', '4', 'applicant', '', 'No', '2016-10-14 02:17:13', '2016-10-14 02:17:58'),
(32, '433702728677', '4', 'applicant', '', 'No', '2016-10-14 02:34:44', '2016-10-14 02:35:22'),
(33, '575149509872', '4', 'applicant', '', 'No', '2016-10-14 02:42:38', '2016-10-14 02:43:37'),
(34, '898420534786', '4', 'applicant', '', 'No', '2016-10-14 03:51:04', '2016-10-14 03:53:07'),
(35, '757298223653', '4', 'applicant', '', 'No', '2016-10-14 04:35:27', '2016-10-14 04:36:00'),
(36, '645304383081376', '4', 'applicant', '', 'No', '2016-10-14 04:48:18', '2016-10-14 04:48:34'),
(37, '111162635543170', '4', 'applicant', '', 'No', '2016-10-14 04:54:30', '2016-10-14 04:54:45'),
(38, '062261181194786', '4', 'applicant', '', 'Yes', '2016-10-14 05:07:12', '2016-10-14 05:07:12'),
(39, '038056511480965', '4', 'applicant', '', 'No', '2016-10-14 05:20:22', '2016-10-14 05:21:16'),
(40, '219658272785341', '4', 'applicant', '', 'Yes', '2016-10-14 05:38:28', '2016-10-14 05:38:28'),
(41, '718313120447640', '4', 'applicant', '', 'No', '2016-10-14 05:46:36', '2016-10-14 05:52:10'),
(42, '246046014600750', '4', 'applicant', '', 'Yes', '2016-10-14 23:10:06', '2016-10-14 23:10:06'),
(43, '998396959749203', '4', 'applicant', '', 'No', '2016-10-14 23:57:13', '2016-10-14 23:59:23'),
(44, '375051632304360', '4', 'applicant', '', 'No', '2016-10-15 00:03:28', '2016-10-15 00:05:14'),
(45, '680408694138760', '4', 'applicant', '', 'No', '2016-10-15 00:06:53', '2016-10-15 00:09:18'),
(46, '921109045890964', '4', 'applicant', '', 'No', '2016-10-15 00:09:23', '2016-10-15 00:10:10'),
(47, '663405999535063', '4', 'applicant', '', 'No', '2016-10-15 00:10:17', '2016-10-15 00:13:37'),
(48, '601216401728923', '4', 'applicant', '', 'No', '2016-10-15 00:18:22', '2016-10-15 00:19:53'),
(49, '475207432421986', '4', 'applicant', '', 'No', '2016-10-15 00:22:18', '2016-10-15 00:24:35'),
(50, '266153572655048', '4', 'applicant', '', 'No', '2016-10-15 01:13:34', '2016-10-15 01:14:33'),
(51, '122639080837990', '4', 'applicant', '', 'No', '2016-10-15 01:25:08', '2016-10-15 01:27:16'),
(52, '372059356622911', '4', 'applicant', '', 'No', '2016-10-15 01:33:09', '2016-10-15 01:34:04'),
(53, '733482692890479', '4', 'applicant', '', 'No', '2016-10-15 01:43:26', '2016-10-15 01:46:56'),
(54, '962721183216004', '4', 'applicant', '', 'No', '2016-10-15 01:47:33', '2016-10-15 01:48:30'),
(55, '447271909185980', '4', 'applicant', '', 'No', '2016-10-15 01:58:57', '2016-10-15 02:00:27'),
(56, '043012210524293', '4', 'applicant', '', 'No', '2016-10-15 02:36:13', '2016-10-15 02:38:01'),
(57, '474909714755606', '4', 'applicant', '', 'No', '2016-10-15 02:39:03', '2016-10-15 02:40:02'),
(58, '187150373670162', '4', 'applicant', '', 'No', '2016-10-18 00:23:16', '2016-10-18 00:23:31'),
(59, '000287308882616', '4', 'applicant', '', 'No', '2016-10-18 00:25:03', '2016-10-18 00:25:12');
...
--
-- Indexes for table `fp_discussions`
--
ALTER TABLE `fp_discussions`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `fp_links_order`
--
ALTER TABLE `fp_links_order`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `fp_payroll_columns`
--
ALTER TABLE `fp_payroll_columns`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fp_payroll_pay_periods`
--
ALTER TABLE `fp_payroll_pay_periods`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `fp_rates`
--
ALTER TABLE `fp_rates`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `fp_task_check_list_status`
--
ALTER TABLE `fp_task_check_list_status`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `fp_user_payroll_columns`
--
ALTER TABLE `fp_user_payroll_columns`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `fp_user_pay_periods`
--
ALTER TABLE `fp_user_pay_periods`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `fp_video_rooms`
--
ALTER TABLE `fp_video_rooms`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fp_video_sessions`
--
ALTER TABLE `fp_video_sessions`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `fp_discussions`
--
ALTER TABLE `fp_discussions`
...
--
-- AUTO_INCREMENT for table `fp_links_order`
--
ALTER TABLE `fp_links_order`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `fp_mail_queue`
MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9443;
--
...
--
-- AUTO_INCREMENT for table `fp_password_resets`
--
ALTER TABLE `fp_password_resets`
...
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fp_payroll_columns`
--
ALTER TABLE `fp_payroll_columns`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `fp_payroll_pay_periods`
--
ALTER TABLE `fp_payroll_pay_periods`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `fp_project`
MODIFY `project_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=132;
--
...
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `fp_rates`
--
ALTER TABLE `fp_rates`
...
--
ALTER TABLE `fp_task`
MODIFY `task_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=152;
--
...
--
-- AUTO_INCREMENT for table `fp_task_check_list_status`
--
ALTER TABLE `fp_task_check_list_status`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=33;
--
...
--
ALTER TABLE `fp_timer`
MODIFY `timer_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=277;
--
...
--
-- AUTO_INCREMENT for table `fp_user_payroll_columns`
--
ALTER TABLE `fp_user_payroll_columns`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fp_user_pay_periods`
--
ALTER TABLE `fp_user_pay_periods`
...
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fp_video_rooms`
--
ALTER TABLE `fp_video_rooms`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `fp_video_sessions`
--
ALTER TABLE `fp_video_sessions`
