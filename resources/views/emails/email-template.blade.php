...
<head>
	...
	<title>Job.tc Email Template</title>
	<style type="text/css">
...
<table align="center" cellpadding="0" cellspacing="0" width="100%" height="100%" >
  <tr>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
      ...
      <tr>
        <td bgcolor="#64594b" valign="top" style="background-color: #64594b; background-position: center;">
          <!--[if gte mso 9]>
          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="mso-width-percent:1000;height:200px;">
            <v:fill type="tile"  color="#64594b" />
              ...
              <table cellspacing="0" cellpadding="0" width="530" height="200" class="w320">
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="200">
                    ...
                    <h1>WELCOME TO <strong>[Company Name]</strong>!</h1><br>
                ...
                <td>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                       Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam architecto est et exercitationem fugit ipsa nesciunt non omnis quae quasi quia quos, rerum sed similique ullam voluptate voluptatibus? Aliquid, ipsum.
                      <br>
                      <br>
                    ...
                    <tr>
                      <td style="width:150px; background-color: #3bcdc3;">
                        <div><!--[if mso]>
                          ...
                          <![endif]-->
                          <!--[if !mso]><!-- -->
                            <a href="#" style="background-color:#3bcdc3;border-radius:0;color:#ffffff;display:inline-block;font-family:'Lato', Helvetica, Arial, sans-serif;font-weight:bold;font-size:13px;line-height:33px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">
                                <span style="color:#ffffff">Back to Website</span>
                            </a>
                          <!--<![endif]-->
                        </div>
                      </td>
